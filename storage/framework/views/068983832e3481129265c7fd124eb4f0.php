                    ...
                    <form action="<?php echo e(route('login.post')); ?>" method="POST" class="space-y-6">
                        ...
                        <div class="text-center">
                            <p class="text-sm text-green-100">
                                ...
                                <a href="<?php echo e(route('signup')); ?>" class="text-white hover:text-green-200 transition-colors duration-200">
                                    Sign up
                                </a>
                            </p>
                        </div>
...
<?php /**PATH C:\Users\sethy\ValesBeach\resources\views\auth\login.blade.php ENDPATH**/ ?>