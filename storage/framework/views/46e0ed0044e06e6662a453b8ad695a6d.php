...
<div class="container mx-auto px-4 lg:px-8 py-8">
    <div class="bg-gray-800 rounded-lg p-6 text-center">
        ...
        <div class="space-x-4">
            <a href="<?php echo e(url('/')); ?>" class="inline-flex items-center px-4 py-2 bg-green-600 text-white rounded hover:bg-green-500 transition-colors">
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\sethy\ValesBeach\resources\views\errors\403.blade.php ENDPATH**/ ?>