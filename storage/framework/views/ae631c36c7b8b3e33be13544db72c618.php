        ...
        <form action="<?php echo e(route('admin.rooms.update', $room)); ?>" method="POST" class="bg-gray-800 rounded-lg shadow-xl p-6" enctype="multipart/form-data">
            ...
            <div class="mb-6">
                ...
                <select name="type" 
                        ...
                        class="w-full bg-gray-700 text-white rounded-lg px-4 py-2"
                        required>
                    <?php $__currentLoopData = ['Standard', 'Deluxe', 'Suite', 'Family']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($type); ?>" <?php echo e(old('type', $room->type) === $type ? 'selected' : ''); ?>>
                            <?php echo e($type); ?>
                        ...
                        <div>
                            <label class="inline-flex items-center text-gray-300">
                                <input type="checkbox" 
                                       ...
                                       <?php echo e(in_array($amenity, old('amenities', json_decode($room->amenities) ?? [])) ? 'checked' : ''); ?>>
            ...
            <!-- Images -->
            <div class="mb-6">
                <label class="block text-gray-300 mb-2">Current Images</label>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\VALESBEACH_LATEST\ValesBeach\resources\views/admin/rooms/edit.blade.php ENDPATH**/ ?>