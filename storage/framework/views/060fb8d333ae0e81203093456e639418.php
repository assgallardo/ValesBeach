        ...
        <div class="mb-8">
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between">
                <div class="mb-4 sm:mb-0">
                    <h1 class="text-3xl font-bold text-green-50">Food Order Sales Report</h1>
        ...
        <div class="bg-gray-800 rounded-lg border border-gray-700 overflow-hidden mb-8">
            ...
            <div class="overflow-x-auto">
                <table class="w-full">
                    <thead class="bg-gray-900">
                        <tr>
                            <th class="px-6 py-3 text-left text-xs font-medium text-gray-300 uppercase tracking-wider">Menu Item</th>
                    ...
                    <tbody class="divide-y divide-gray-700">
                        <?php $__empty_0 = true; $__currentLoopData = $revenueByItem->take(20); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_0 = false; ?>
                        <tr class="hover:bg-gray-700/50">
                ...
                <div class="bg-gradient-to-br from-gray-800 via-gray-800 to-gray-900 rounded-2xl border border-yellow-600/30 overflow-hidden shadow-2xl sticky top-6">
                    ...
                    <div class="bg-gradient-to-r from-yellow-600 via-amber-500 to-yellow-600 px-6 py-5 text-center relative overflow-hidden">
                        ...
                        <div class="relative z-10">
                            ...
                            <h3 class="text-xl font-bold text-white mb-1">Top Selling Items</h3>
                            <p class="text-yellow-100 text-xs">Most Ordered Menu Items</p>
                        </div>
                    </div>

                    <div class="p-6 space-y-3">
                        <?php $__empty_0 = true; $__currentLoopData = $topMenuItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_0 = false; ?>
                    ...
                    <div class="bg-gradient-to-r from-gray-900 to-gray-800 px-6 py-3 border-t border-gray-700">
                        <div class="flex items-center justify-center text-xs text-gray-400">
                            ...
                            <span>Based on total quantity sold</span>
                        </div>
                    </div>
                </div>
            </div>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\sethy\ValesBeach\resources\views\manager\reports\food-sales.blade.php ENDPATH**/ ?>