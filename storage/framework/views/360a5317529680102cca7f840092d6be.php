...
<div class="container mx-auto px-4 lg:px-16 py-8">
    ...
    <div class="bg-gray-800 rounded-lg p-6 mb-6">
        <form action="<?php echo e(route('manager.rooms.index')); ?>" method="GET" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            <!-- Search -->
            <div>
                ...
                <tbody class="divide-y divide-gray-600">
                    <?php $__empty_1 = true; $__currentLoopData = $rooms; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $room): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr class="text-gray-300 hover:bg-gray-700">
                            ...
                            <td class="px-6 py-4"><?php echo e($room->type); ?></td>
                            ...
                            <td class="px-6 py-4">
                                <div class="flex space-x-3">
                                    ...
                                    <button onclick="toggleAvailability(<?php echo e($room->id); ?>, <?php echo e($room->is_available); ?>)"
                                        ...
                                        <?php echo e($room->is_available ? 'Set Unavailable' : 'Set Available'); ?>
...
<?php echo $__env->make('layouts.manager', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\valesbeachresort\ValesBeach\resources\views/manager/rooms/index.blade.php ENDPATH**/ ?>