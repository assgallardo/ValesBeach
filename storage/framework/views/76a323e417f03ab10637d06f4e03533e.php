...
<div class="min-h-screen bg-gray-900 py-6">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="mt-8 flex flex-col sm:flex-row gap-4 no-print">
            ...
            <a 
                href="<?php echo e(route('admin.payments.customer', ['user' => $invoice->user_id])); ?>" 
                class="flex-1 bg-blue-600 text-white px-6 py-3 rounded-lg font-medium text-center hover:bg-blue-700 transition-colors"
            >
...
<?php echo $__env->make('layouts.invoice', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\VALESBEACH_LATEST\ValesBeach\resources\views/invoices/show.blade.php ENDPATH**/ ?>