<?php $__env->startSection('title', 'Payment Tracking'); ?>
...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <div class="d-flex gap-2">
            ...
            <a href="<?php echo e(route('manager.payments.analytics')); ?>" class="btn btn-info btn-sm">
                <i class="fas fa-chart-bar"></i> Analytics
            </a>
            <a href="<?php echo e(route('manager.payments.export', request()->query())); ?>" class="btn btn-success btn-sm">
                    ...
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            ...
                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                                ₱<?php echo e(number_format($stats['total_payments'], 2)); ?>
                ...
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            ...
                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                                ₱<?php echo e(number_format($stats['pending_payments'], 2)); ?>

                            </div>
                            <div class="text-xs text-muted"><?php echo e($stats['pending_count']); ?> payments</div>
                        </div>
                        <div class="col-auto">
                ...
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            ...
                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                                ₱<?php echo e(number_format($stats['today_payments'], 2)); ?>
                ...
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            ...
                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                                <?php echo e($stats['total_transactions']); ?>
        ...
        <div class="col-12">
            <div class="card shadow-sm">
                <div class="card-body py-2">
                    <form method="GET" action="<?php echo e(route('manager.payments.index')); ?>" id="managerSearchForm">
                        ...
                        <div class="input-group">
                            ...
                            <?php if(request('search')): ?>
                                <div class="input-group-append">
                                    <a href="<?php echo e(route('manager.payments.index', request()->except('search'))); ?>" 
    ...
    <div class="row">
        ...
        <div class="col-lg-8">
            <div class="card shadow mb-4">
                <div class="card-header py-3 d-flex justify-content-between align-items-center">
                    ...
                    <span class="badge badge-primary badge-pill"><?php echo e($customers->total()); ?> Customers</span>
                </div>
                <div class="card-body">
                        ...
                        <div class="table-responsive">
                            ...
                            <?php $__currentLoopData = $customers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $customer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <tr>
                                    <!-- Guest Info -->
                                    <td>
                                        <div class="font-weight-bold"><?php echo e($customer->name); ?></div>
                                    ...
                                    <td>
                                        <?php if($bookingPayments->count() > 0): ?>
                                            <div><i class="fas fa-bed text-primary"></i> <?php echo e($bookingPayments->count()); ?> Booking<?php echo e($bookingPayments->count() > 1 ? 's' : ''); ?></div>
                                        <?php endif; ?>
                                        <?php if($servicePayments->count() > 0): ?>
                                            <div><i class="fas fa-concierge-bell text-purple"></i> <?php echo e($servicePayments->count()); ?> Service<?php echo e($servicePayments->count() > 1 ? 's' : ''); ?></div>
                                        <?php endif; ?>
                                        <?php if($foodPayments->count() > 0): ?>
                                            <div><i class="fas fa-utensils text-warning"></i> <?php echo e($foodPayments->count()); ?> Food</div>
                                        <?php endif; ?>
                                    </td>
                                    
                                    <!-- Total Amount -->
                                    <td>
                                        <strong class="text-success">₱<?php echo e(number_format($totalAmount, 2)); ?></strong>
                                    </td>
                                    
                                    <!-- Transactions -->
                                    <td>
                                        <span class="badge badge-info"><?php echo e($customer->payments->count()); ?> payment<?php echo e($customer->payments->count() > 1 ? 's' : ''); ?></span>
                                    </td>
                                    ...
                                    <td>
                                        <div class="d-flex flex-column gap-1">
                                            <?php if($completedCount > 0): ?>
                                                <span class="badge badge-success badge-sm"><?php echo e($completedCount); ?> Completed</span>
                                            <?php endif; ?>
                                            <?php if($confirmedCount > 0): ?>
                                                <span class="badge badge-primary badge-sm"><?php echo e($confirmedCount); ?> Confirmed</span>
                                            <?php endif; ?>
                                            <?php if($pendingCount > 0): ?>
                                                <span class="badge badge-warning badge-sm"><?php echo e($pendingCount); ?> Pending</span>
                                            <?php endif; ?>
                                            <?php if($overdueCount > 0): ?>
                                                <span class="badge badge-danger badge-sm"><?php echo e($overdueCount); ?> Overdue</span>
                                            <?php endif; ?>
                                            <?php if($refundedCount > 0): ?>
                                                <span class="badge badge-secondary badge-sm"><?php echo e($refundedCount); ?> Refunded</span>
                                            <?php endif; ?>
                                        </div>
                                    </td>
                                    ...
                                    <td>
                                        <?php if($latestPayment): ?>
                                            <div><?php echo e($latestPayment->created_at->format('M d, Y')); ?></div>
                                            <div class="small text-muted"><?php echo e($latestPayment->created_at->format('h:i A')); ?></div>
                                        <?php endif; ?>
                                    </td>
                                    
                                    <!-- Action -->
                                    <td>
                                        <a href="<?php echo e(route('manager.payments.customer', $customer->id)); ?>" class="btn btn-sm btn-primary">
        ...
        <!-- Recent Activity -->
        <div class="col-lg-4">
            <?php if($recent_payments->count() > 0): ?>
            <div class="card shadow mb-4">
                <div class="card-header py-3 d-flex justify-content-between align-items-center">
                ...
                <div class="card-body">
                                ...
                                <div class="card-body p-3">
                                    <div class="d-flex justify-content-between align-items-start mb-2">
                                        <div class="flex-grow-1">
                                            ...
                                            <div class="small text-muted"><?php echo e($payment->payment_reference); ?></div>
                                        </div>
                                        <?php
                                            $statusColors = [
                                                'completed' => 'success',
                                    ...
                                    <div class="mb-2">
                                        ...
                                        <div class="small text-muted">
                                            <i class="fas fa-<?php echo e($payment->payment_method === 'cash' ? 'money-bill-wave' : ($payment->payment_method === 'card' ? 'credit-card' : 'mobile-alt')); ?> mr-1"></i>
                                    ...
                                    <a href="<?php echo e(route('manager.payments.show', $payment)); ?>" 
                    ...
                    <div class="d-flex justify-content-center mt-3">
                        <?php echo e($servicePayments->links()); ?>
                    ...
                    <?php if($recent_payments->count() > 0): ?>
                        ...
                        <?php $__currentLoopData = $recent_payments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $payment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="list-group-item px-0 py-2">
                                ...
                                <div class="flex-grow-1">
                                        <div class="font-weight-bold small">₱<?php echo e(number_format($payment->amount, 2)); ?></div>
                                        <div class="text-xs text-muted"><?php echo e($payment->user->name); ?></div>
                                        <div class="text-xs text-muted">
                                            <i class="fas fa-clock mr-1"></i><?php echo e($payment->created_at->diffForHumans()); ?>
                                    ...
                                    ?>
                                    <span class="badge badge-<?php echo e($statusColors[$payment->status] ?? 'secondary'); ?> badge-sm">
                                        <?php echo e(ucfirst($payment->status)); ?>
...
<div class="modal fade" id="filterModal" tabindex="-1" role="dialog">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form method="GET" action="<?php echo e(route('manager.payments.index')); ?>">
                <div class="modal-body">
                        ...
                        <select name="payment_status" class="form-control">
                            ...
                            <option value="paid" <?php echo e(request('payment_status') === 'paid' ? 'selected' : ''); ?>>Fully Paid</option>
                                </select>
                            </div>
                ...
                <div class="modal-footer">
                    ...
                    <a href="<?php echo e(route('manager.payments.index')); ?>" class="btn btn-outline-secondary">Clear</a>
...
if (ctx) {
    const trendsData = <?php echo json_encode($payment_trends, 15, 512) ?>;
...
<?php echo $__env->make('layouts.manager', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\sethy\ValesBeach\resources\views\manager\payments\index.blade.php ENDPATH**/ ?>