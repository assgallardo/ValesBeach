...
<div class="container mx-auto px-4 lg:px-8 py-8">
    ...
    <div class="bg-gray-800 rounded-lg p-6 mb-8">
        <form action="<?php echo e(route('manager.bookings.index')); ?>" method="GET" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            <!-- Search -->
            <div>
        ...
        <div class="overflow-x-auto">
            <table class="w-full text-left">
                ...
                <tbody class="divide-y divide-gray-700">
                    ...
                    <tr class="text-gray-300 hover:bg-gray-700/50" id="booking-row-<?php echo e($booking->id); ?>">
                        <td class="px-6 py-4">
                        ...
                        <td class="px-6 py-4">
                            <div class="text-white booking-room-name"><?php echo e($booking->room->name ?? 'Room #' . ($booking->room_id ?? 'N/A')); ?></div>
                            <div class="text-sm text-gray-400 booking-guests"><?php echo e($booking->guests ?? 'N/A'); ?> guests</div>
                        </td>
                        <td class="px-6 py-4 booking-dates">
                            <?php if(isset($booking->check_in) && $booking->check_in && isset($booking->check_out) && $booking->check_out): ?>
                        ...
                        <td class="px-6 py-4">
                            <div class="text-green-400 font-bold text-lg booking-total">₱<?php echo e(number_format($booking->total_price ?? 0, 2)); ?></div>
                            <?php if(isset($booking->check_in) && $booking->check_in && isset($booking->check_out) && $booking->check_out): ?>
                        ...
                        <td class="px-6 py-4">
                            ...
                            <span class="px-3 py-1 rounded-full text-xs font-medium
                                ...
                                <?php elseif($status === 'confirmed'): ?> bg-green-100 text-green-800
                                <?php elseif($status === 'checked_in'): ?> bg-blue-100 text-blue-800
                                <?php elseif($status === 'checked_out'): ?> bg-gray-100 text-gray-800
                                <?php elseif($status === 'cancelled'): ?> bg-red-100 text-red-800
                                <?php elseif($status === 'completed'): ?> bg-purple-100 text-purple-800
                        ...
                        <td class="px-6 py-4">
                            <div class="flex items-center space-x-3">
                                ...
                                <button type="button"
                                        onclick="editBookingDetails(<?php echo e(json_encode($booking)); ?>)"
                            ...
                            <select name="room_id" id="edit_room_id" required
                                ...
                                <?php $__currentLoopData = $rooms; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $room): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($room->id); ?>" data-price="<?php echo e($room->price); ?>">
                                        <?php echo e($room->name); ?> - ₱<?php echo e(number_format($room->price, 2)); ?>/night (<?php echo e($room->capacity); ?> guests)
                                    </option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
                        </div>
...
function updateStatus(bookingId) {
    ...
    form.action = `<?php echo e(url('manager/bookings')); ?>/${bookingId}/status`;
    modal.classList.remove('hidden');
}
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\valesbeachresort\ValesBeach\resources\views/manager/bookings/index.blade.php ENDPATH**/ ?>