...
<div class="max-w-5xl mx-auto">
    ...
    <div class="bg-gray-800 rounded-lg shadow-xl overflow-hidden">
        <form action="<?php echo e(route('manager.services.store')); ?>" method="POST" enctype="multipart/form-data" class="p-6">
            <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>"
                                ...
                                <option value="spa" <?php echo e(old('category') === 'spa' ? 'selected' : ''); ?>>Spa & Wellness</option>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\valesbeachresort\ValesBeach\resources\views/manager/services/create.blade.php ENDPATH**/ ?>