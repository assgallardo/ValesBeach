...
<div class="max-w-7xl mx-auto">
    ...
    <div class="bg-gray-800 rounded-lg shadow-xl overflow-hidden">
        <form action="<?php echo e(route('staff.menu.store')); ?>" method="POST" enctype="multipart/form-data" class="p-6">
            <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>"
                                ...
                                <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($category->id); ?>" <?php echo e(old('menu_category_id') == $category->id ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <input type="text" 
                               id="ingredients" 
                               name="ingredients" 
                               value="<?php echo e(old('ingredients')); ?>"
                    ...
                    <div>
                        ...
                        <input type="text" 
                               id="allergens" 
                               name="allergens" 
                               value="<?php echo e(old('allergens')); ?>"
                               class="w-full bg-gray-700 text-white rounded-lg px-4 py-2.5 border border-gray-600 focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent"
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <input type="number" 
                                   ...
                                   value="<?php echo e(old('preparation_time', 15)); ?>"
                                   class="w-full bg-gray-700 text-white rounded-lg px-4 py-2.5 border border-gray-600 focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent"
                                   placeholder="15">
                        </div>
                        ...
                        <div class="space-y-2">
                            ...
                            <label class="flex items-center text-gray-300 cursor-pointer hover:text-white transition-colors">
                                <input type="checkbox" 
                                       ...
                                       name="is_vegan" 
                                       value="1"
                                       <?php echo e(old('is_vegan') ? 'checked' : ''); ?>
                            ...
                            <label class="flex items-center text-gray-300 cursor-pointer hover:text-white transition-colors">
                                <input type="checkbox" 
                                       ...
                                       name="is_gluten_free" 
                                       value="1"
                                       <?php echo e(old('is_gluten_free') ? 'checked' : ''); ?>
                            ...
                            <label class="flex items-center text-gray-300 cursor-pointer hover:text-white transition-colors">
                                <input type="checkbox" 
                                       ...
                                       name="is_dairy_free" 
                                       value="1"
                                       <?php echo e(old('is_dairy_free') ? 'checked' : ''); ?>
...
<?php echo $__env->make('layouts.staff', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\valesbeachresort\ValesBeach\resources\views/staff/menu/create.blade.php ENDPATH**/ ?>