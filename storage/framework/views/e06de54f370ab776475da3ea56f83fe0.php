                    ...
                    <div class="space-y-4">
                        ...
                        <div class="flex justify-between items-center p-4 bg-green-800/50 rounded-lg">
                            <div>
                                ...
                                <p class="text-green-300 text-sm"><?php echo e($month->count); ?> bookings</p>
                            </div>
                            <div class="text-right">
                                <p class="text-green-50 font-bold"><?php echo e($month->count); ?></p>
                ...
                <div class="bg-green-900/50 backdrop-blur-sm rounded-lg p-8">
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="flex justify-between items-center p-4 bg-green-800/50 rounded-lg">
                            ...
                            <div class="text-right">
                                <p class="text-green-50 font-bold"><?php echo e($room->bookings_count ?? 0); ?></p>
...
<?php echo $__env->make('layouts.manager', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\sethy\ValesBeach\resources\views\manager\reports.blade.php ENDPATH**/ ?>