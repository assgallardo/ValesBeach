                                ...
                                <div class="space-y-4">
                                    ...
                                    <div class="border border-green-700 rounded-lg p-4 bg-green-800 bg-opacity-30">
                                        ...
                                        <p class="text-gray-400 text-sm mt-2 ml-8">
                                            Check-in before <?php echo e(!empty($room->check_in_time) ? \Carbon\Carbon::createFromFormat('H:i:s', $room->check_in_time)->format('g:i A') : '2:00 PM'); ?> 
                                            (Additional fee: ₱500)
                                        </p>
                                    </div>
                                    ...
                                    <div class="border border-green-700 rounded-lg p-4 bg-green-800 bg-opacity-30">
                                        ...
                                        <p class="text-gray-400 text-sm mt-2 ml-8">
                                            Check-out after <?php echo e(!empty($room->check_out_time) ? \Carbon\Carbon::createFromFormat('H:i:s', $room->check_out_time)->format('g:i A') : '12:00 PM'); ?> 
                                            (Additional fee: ₱500)
                                        </p>
                                    </div>
