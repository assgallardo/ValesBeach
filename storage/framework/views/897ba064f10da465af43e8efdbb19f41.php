    ...
    <div class="bg-gray-800 rounded-lg shadow-xl p-6 mb-6">
        <div class="flex flex-wrap gap-2">
            <a href="<?php echo e(route('manager.services.index')); ?>" 
               class="px-4 py-2 rounded-lg font-medium transition-colors duration-200 <?php echo e(!request('category') ? 'bg-green-600 text-white' : 'bg-gray-700 text-gray-300 hover:bg-gray-600 hover:text-white'); ?>">
                All Services
            </a>
            <a href="<?php echo e(route('manager.services.index', ['category' => 'spa'])); ?>" 
               class="px-4 py-2 rounded-lg font-medium transition-colors duration-200 <?php echo e(request('category') === 'spa' ? 'bg-green-600 text-white' : 'bg-gray-700 text-gray-300 hover:bg-gray-600 hover:text-white'); ?>">
                Spa & Wellness
            </a>
            <a href="<?php echo e(route('manager.services.index', ['category' => 'dining'])); ?>" 
               class="px-4 py-2 rounded-lg font-medium transition-colors duration-200 <?php echo e(request('category') === 'dining' ? 'bg-green-600 text-white' : 'bg-gray-700 text-gray-300 hover:bg-gray-600 hover:text-white'); ?>">
                Dining
            </a>
            <a href="<?php echo e(route('manager.services.index', ['category' => 'room_service'])); ?>" 
               class="px-4 py-2 rounded-lg font-medium transition-colors duration-200 <?php echo e(request('category') === 'room_service' ? 'bg-green-600 text-white' : 'bg-gray-700 text-gray-300 hover:bg-gray-600 hover:text-white'); ?>">
                Room Service
            </a>
            <a href="<?php echo e(route('manager.services.index', ['category' => 'transportation'])); ?>" 
               class="px-4 py-2 rounded-lg font-medium transition-colors duration-200 <?php echo e(request('category') === 'transportation' ? 'bg-green-600 text-white' : 'bg-gray-700 text-gray-300 hover:bg-gray-600 hover:text-white'); ?>">
                Transportation
            </a>
            <a href="<?php echo e(route('manager.services.index', ['category' => 'activities'])); ?>" 
               class="px-4 py-2 rounded-lg font-medium transition-colors duration-200 <?php echo e(request('category') === 'activities' ? 'bg-green-600 text-white' : 'bg-gray-700 text-gray-300 hover:bg-gray-600 hover:text-white'); ?>">
                Activities
            </a>
        </div>
    </div>
        ...
        <div class="bg-gray-800 rounded-lg shadow-xl overflow-hidden hover:shadow-2xl transition-shadow duration-300">
            ...
            <div class="h-48 bg-gray-700 relative">
                ...
                <div class="absolute bottom-3 left-3">
                    <span class="px-3 py-1 rounded-full text-xs font-semibold <?php echo e($service->is_available ? 'bg-green-900 text-green-200' : 'bg-red-900 text-red-200'); ?>">
            ...
            <!-- Service Details -->
            <div class="p-6">
                <h3 class="text-lg font-bold text-white mb-2"><?php echo e($service->name); ?></h3>
                
                <p class="text-gray-400 text-sm mb-4 line-clamp-3"><?php echo e($service->description); ?></p>
                ...
                <div class="space-y-2 mb-4">
                    ...
                    <div class="flex justify-between text-sm">
                        ...
                        <span class="text-white"><?php echo e($service->capacity); ?> <?php echo e($service->capacity === 1 ? 'person' : 'people'); ?></span>
                    </div>
                    <?php endif; ?>
                    <div class="flex justify-between text-sm">
                        <span class="text-gray-400">Created:</span>
                        <span class="text-white"><?php echo e($service->created_at->format('M d, Y')); ?></span>
                    </div>
                </div>
                ...
                <div class="space-y-2">
                    ...
                    <div class="flex gap-2">
                        <!-- Toggle Status -->
                        <form action="<?php echo e(route('manager.services.toggle-status', $service)); ?>" method="POST" class="flex-1">
                            <?php echo csrf_field(); ?>
                            <?php echo method_field('PATCH'); ?>
                            <button type="submit" class="w-full py-2 px-3 rounded-lg text-sm font-medium transition-colors duration-200 <?php echo e($service->is_available ? 'bg-yellow-600 hover:bg-yellow-700 text-white' : 'bg-green-600 hover:bg-green-700 text-white'); ?>">
                                <svg class="w-4 h-4 inline mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7h12m0 0l-4-4m4 4l-4 4m0 6H4m0 0l4 4m-4-4l4-4"/>
                                </svg>
                                <?php echo e($service->is_available ? 'Disable' : 'Enable'); ?>
...
<?php echo $__env->make('layouts.manager', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\VALESBEACH_LATEST\ValesBeach\resources\views/manager/services/index.blade.php ENDPATH**/ ?>