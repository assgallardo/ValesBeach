...
<div class="min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 py-8">
    <div class="max-w-6xl mx-auto px-4">
        <form action="<?php echo e(isset($invoice) ? route('admin.invoices.update', $invoice->id) : route('admin.payments.customer.invoice.save', $customer->id)); ?>" method="POST" id="invoiceForm">
            <?php echo csrf_field(); ?>
