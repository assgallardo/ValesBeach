                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <?php elseif($payment->booking && $payment->booking->room): ?>
                                    ...
                                    ?>
                                    <div class="text-sm text-gray-400 mt-1">
                                        Room: <?php echo e($payment->booking->room->name); ?> (<?php echo e($nights); ?> night<?php echo e($nights > 1 ? 's' : ''); ?>)
                                    </div>
                                <?php endif; ?>
                            </div>
                        ...
                        <div class="p-6">
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <div class="text-green-400 font-medium">#<?php echo e($payment->foodOrder->id); ?></div>
                                </div>
                                <div>
                                    <label class="block text-sm font-medium text-gray-400 mb-2">Status</label>
                                    <span class="px-3 py-1 rounded-full text-sm font-medium
                                        <?php echo e($payment->foodOrder->status === 'pending' ? 'bg-yellow-600 text-yellow-100' : ''); ?>

                                        <?php echo e($payment->foodOrder->status === 'preparing' ? 'bg-blue-600 text-blue-100' : ''); ?>

                                        <?php echo e($payment->foodOrder->status === 'ready' ? 'bg-green-600 text-green-100' : ''); ?>

                                        <?php echo e($payment->foodOrder->status === 'delivered' ? 'bg-purple-600 text-purple-100' : ''); ?>

                                        <?php echo e($payment->foodOrder->status === 'cancelled' ? 'bg-red-600 text-red-100' : ''); ?>
                                ...
                                <?php if($payment->foodOrder->orderItems && $payment->foodOrder->orderItems->count() > 0): ?>
                                    <div class="md:col-span-2">
                                        ...
                                        <div class="bg-gray-900 rounded border border-gray-600">
                                            <table class="w-full">
                                                ...
                                                <tbody class="divide-y divide-gray-700">
                                                    <?php $__currentLoopData = $payment->foodOrder->orderItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <tr>
                                                            <td class="px-4 py-3 text-gray-300"><?php echo e($item->menuItem->name ?? 'N/A'); ?></td>
                                                            <td class="px-4 py-3 text-gray-300"><?php echo e($item->quantity); ?></td>
                                                            <td class="px-4 py-3 text-right text-gray-300">₱<?php echo e(number_format($item->unit_price, 2)); ?></td>
                                                            <td class="px-4 py-3 text-right text-green-400 font-semibold">₱<?php echo e(number_format($item->total_price, 2)); ?></td>
                                                        </tr>
                                ...
                                <div>
                                    ...
                                    <div class="text-xl font-semibold text-green-400">₱<?php echo e(number_format($payment->foodOrder->total_amount ?? $payment->amount, 2)); ?></div>
                                </div>
                                
                                <?php if($payment->foodOrder->delivery_address): ?>
                                    <div>
                                        <label class="block text-sm font-medium text-gray-400 mb-2">Delivery Address</label>
                                        <div class="text-gray-300"><?php echo e($payment->foodOrder->delivery_address); ?></div>
                                    </div>
                                <?php endif; ?>
                                
                                <?php if($payment->foodOrder->created_at): ?>
                                    <div>
                                        <label class="block text-sm font-medium text-gray-400 mb-2">Order Date</label>
                                        <div class="text-gray-300"><?php echo e($payment->foodOrder->created_at->format('M d, Y h:i A')); ?></div>
                                    </div>
                                <?php endif; ?>
                            </div>
                            
                            <?php if($payment->foodOrder->special_instructions): ?>
                                <div class="mt-6">
                                    <label class="block text-sm font-medium text-gray-400 mb-2">Special Instructions</label>
                                    <div class="bg-gray-900 p-3 rounded border border-gray-600">
                                        <div class="text-gray-300"><?php echo e($payment->foodOrder->special_instructions); ?></div>
                                    </div>
                                </div>
                            <?php endif; ?>
                        </div>
            ...
            <div class="space-y-6">
                ...
                <div class="bg-gray-800 rounded-lg border border-gray-700 overflow-hidden">
                    ...
                    <div class="p-6 space-y-3">
                        ...
                        <?php endif; ?>
                        <?php if($payment->refund_amount > 0): ?>
                            <form method="POST" action="<?php echo e(route('admin.payments.cancelRefund', $payment)); ?>" class="w-full mt-2">
                                <?php echo csrf_field(); ?>
                        ...
                        <?php if($payment->status === 'pending'): ?>
                            <form method="POST" action="<?php echo e(route('admin.payments.updateStatus', $payment)); ?>" class="w-full">
                                <?php echo csrf_field(); ?>
