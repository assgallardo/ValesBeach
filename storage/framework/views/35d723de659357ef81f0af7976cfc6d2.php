        ...
        <div class="container mx-auto px-4 lg:px-16">
            <div class="flex items-center justify-between h-16">
                ...
                <div class="flex items-center">
                    <a href="<?php echo e(route('admin.dashboard')); ?>" class="text-white font-bold text-xl">
                        Vales Beach Admin
                    </a>
                </div>
                    ...
                    <div class="flex items-center space-x-4">
                        <a href="<?php echo e(route('admin.dashboard')); ?>" 
                           class="text-gray-300 hover:bg-green-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium
                                  <?php echo e(request()->routeIs('admin.dashboard') ? 'bg-green-700 text-white' : ''); ?>">
                            Dashboard
                        </a>
                        <a href="<?php echo e(route('admin.rooms.index')); ?>" 
                           class="text-gray-300 hover:bg-green-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium
                                  <?php echo e(request()->routeIs('admin.rooms.*') ? 'bg-green-700 text-white' : ''); ?>">
                            Rooms
                        </a>
                        <a href="<?php echo e(route('admin.reservations')); ?>" 
                           class="text-gray-300 hover:bg-green-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium
                                  <?php echo e(request()->routeIs('admin.reservations*') || request()->routeIs('admin.bookings*') ? 'bg-green-700 text-white' : ''); ?>">
                            Reservations
                        </a>
                        <a href="<?php echo e(route('admin.calendar')); ?>" 
                           class="text-gray-300 hover:bg-green-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium
                                  <?php echo e(request()->routeIs('admin.calendar*') ? 'bg-green-700 text-white' : ''); ?>">
                            Calendar
                        </a>
                        <?php if(auth()->user()->role === 'admin'): ?>
                        <a href="<?php echo e(route('admin.users')); ?>" 
                           class="text-gray-300 hover:bg-green-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium
                                  <?php echo e(request()->routeIs('admin.users*') ? 'bg-green-700 text-white' : ''); ?>">
                            Users
                        </a>
                        <?php endif; ?>
                    </div>
                ...
                <div class="flex items-center">
                    <div x-data="{ open: false }" class="relative">
                        <button @click="open = !open" type="button" class="flex items-center text-gray-300 hover:text-white focus:outline-none">
                        ...
                        <div x-show="open" 
                            ...
                            <form method="POST" action="<?php echo e(route('logout')); ?>">
                                <?php echo csrf_field(); ?>
                                <button type="submit" class="block w-full text-left px-4 py-2 text-sm text-gray-300 hover:bg-green-700 hover:text-white">
                                    Logout
                                </button>
                            </form>
                        </div>
