    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="mb-8">
            <div class="flex items-center justify-between mb-2">
                ...
                <a href="<?php echo e(route('admin.payments.customer.invoice', $customer->id)); ?>" 
            ...
            <div class="flex items-start justify-between">
                ...
                <div class="text-right">
                    ...
                    <div class="text-3xl font-bold text-green-400">
                        ₱<?php echo e(number_format($customer->payments->sum('amount'), 2)); ?>

                    </div>
                    <div class="text-sm text-gray-400 mt-1">
                        <?php echo e($customer->payments->count()); ?> transaction<?php echo e($customer->payments->count() !== 1 ? 's' : ''); ?>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-6">
            ...
            <div class="bg-gray-800 rounded-lg border border-gray-700 p-6">
                ...
                <div class="text-2xl font-bold text-green-400">
                    ₱<?php echo e(number_format($customer->payments->where('booking_id', '!=', null)->sum('amount'), 2)); ?>

                </div>
                <div class="text-sm text-gray-400 mt-1">
                    <?php echo e($customer->payments->where('booking_id', '!=', null)->count()); ?> payment<?php echo e($customer->payments->where('booking_id', '!=', null)->count() !== 1 ? 's' : ''); ?>
            ...
            <div class="bg-gray-800 rounded-lg border border-gray-700 p-6">
                ...
                <div class="text-2xl font-bold text-green-400">
                    ₱<?php echo e(number_format($customer->payments->where('service_request_id', '!=', null)->sum('amount'), 2)); ?>

                </div>
                <div class="text-sm text-gray-400 mt-1">
                    <?php echo e($customer->payments->where('service_request_id', '!=', null)->count()); ?> payment<?php echo e($customer->payments->where('service_request_id', '!=', null)->count() !== 1 ? 's' : ''); ?>
            ...
            <div class="bg-gray-800 rounded-lg border border-gray-700 p-6">
                ...
                <div class="text-2xl font-bold text-green-400">
                    ₱<?php echo e(number_format($customer->payments->where('food_order_id', '!=', null)->sum('amount'), 2)); ?>

                </div>
                <div class="text-sm text-gray-400 mt-1">
                    <?php echo e($customer->payments->where('food_order_id', '!=', null)->count()); ?> order<?php echo e($customer->payments->where('food_order_id', '!=', null)->count() !== 1 ? 's' : ''); ?>
            ...
            <div class="bg-gray-800 rounded-lg border border-gray-700 p-6">
                ...
                <div class="text-2xl font-bold text-green-400">
                    ₱<?php echo e(number_format($customer->payments->whereNull('booking_id')->whereNull('service_request_id')->whereNull('food_order_id')->sum('amount'), 2)); ?>

                </div>
                <div class="text-sm text-gray-400 mt-1">
                    <?php echo e($customer->payments->whereNull('booking_id')->whereNull('service_request_id')->whereNull('food_order_id')->count()); ?> charge<?php echo e($customer->payments->whereNull('booking_id')->whereNull('service_request_id')->whereNull('food_order_id')->count() !== 1 ? 's' : ''); ?>
