                ...
                <tbody class="divide-y divide-gray-700">
                    <?php $__empty_1 = true; $__currentLoopData = $menuItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr class="hover:bg-gray-700 transition-colors duration-150">
                            ...
                            <td class="px-6 py-4">
                                <div class="text-white font-semibold text-lg"><?php echo e($item->name); ?></div>
                                <div class="text-gray-400 text-sm mt-1"><?php echo e(Str::limit($item->description, 60)); ?></div>
                            </td>
                            <td class="px-6 py-4">
                                <span class="inline-flex items-center px-3 py-1 rounded-full text-sm font-medium bg-blue-900 text-blue-200">
                                    <?php echo e($item->menuCategory->name ?? 'N/A'); ?>

                                </span>
                            </td>
                            <td class="px-6 py-4">
                                <span class="text-white font-bold text-lg">₱<?php echo e(number_format($item->price, 2)); ?></span>
                            </td>
                            <td class="px-6 py-4 text-center">
                                <form action="<?php echo e(route('staff.menu.toggle-availability', $item)); ?>" method="POST">
                                    <?php echo csrf_field(); ?>
                                    <button type="submit" 
                                            class="px-4 py-2 rounded-lg text-sm font-semibold transition-colors duration-200 <?php echo e($item->is_available ? 'bg-green-600 hover:bg-green-700 text-white' : 'bg-gray-600 hover:bg-gray-700 text-gray-300'); ?>">
                            ...
                            <td class="px-6 py-4 text-center">
                                <form action="<?php echo e(route('staff.menu.toggle-featured', $item)); ?>" method="POST">
                                    <?php echo csrf_field(); ?>
                                    <button type="submit" 
                                            class="p-2 rounded-lg transition-colors duration-200 <?php echo e($item->is_featured ? 'bg-yellow-500 hover:bg-yellow-600 text-white' : 'bg-gray-600 hover:bg-gray-700 text-gray-400'); ?>">
                            ...
                            <td class="px-6 py-4">
                                <div class="flex items-center justify-center space-x-2">
                                    <a href="<?php echo e(route('staff.menu.edit', $item)); ?>" 
                                    ...
                                    <form action="<?php echo e(route('staff.menu.destroy', $item)); ?>" method="POST" 
...
<?php echo $__env->make('layouts.staff', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\VALESBEACH_LATEST\ValesBeach\resources\views/staff/menu/index.blade.php ENDPATH**/ ?>