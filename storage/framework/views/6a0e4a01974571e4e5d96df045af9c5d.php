                            ...
                            <div class="mb-4 bg-yellow-500/20 border border-yellow-500/30 rounded-lg p-3">
                                <div class="flex items-center justify-center">
                                    ...
                                    <span class="text-yellow-400 text-sm font-medium">
                                        <?php echo e($pendingAssignments); ?> pending assignment<?php echo e($pendingAssignments > 1 ? 's' : ''); ?>
...
<?php echo $__env->make('layouts.manager', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\valesbeachresort\ValesBeach\resources\views/manager/dashboard.blade.php ENDPATH**/ ?>