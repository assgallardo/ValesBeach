                    ...
                    <div class="flex flex-wrap justify-between items-start gap-4">
                        <div>
                            ...
                            <p class="text-gray-300">
                                Check-in: <?php echo e(\Carbon\Carbon::parse($booking->check_in ?? $booking->check_in_date)->format('M d, Y')); ?> at <?php echo e($booking->room && $booking->room->check_in_time ? \Carbon\Carbon::parse($booking->room->check_in_time)->format('g:i A') : '12:00 AM'); ?>

                            </p>
                            <p class="text-gray-300">
                                Check-out: <?php echo e(\Carbon\Carbon::parse($booking->check_out ?? $booking->check_out_date)->format('M d, Y')); ?> at <?php echo e($booking->room && $booking->room->check_out_time ? \Carbon\Carbon::parse($booking->room->check_out_time)->format('g:i A') : '12:00 AM'); ?>
...
<?php echo $__env->make('layouts.guest', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\VALESBEACH_LATEST\ValesBeach\resources\views/guest/bookings/history.blade.php ENDPATH**/ ?>