                ...
                <div class="flex items-center space-x-6 lg:space-x-8">
                    <?php if(auth()->guard()->check()): ?>
                        ...
                        <div class="flex items-center space-x-4">
                            <span class="text-white text-lg"><?php echo e(auth()->user()->name); ?></span>
                    ...
                    <?php else: ?>
                        <a href="<?php echo e(route('login')); ?>" class="text-white text-lg hover:text-green-200 transition-colors duration-200">
                            Login
                        </a>
                        <a href="<?php echo e(route('signup')); ?>" class="px-6 py-2 bg-green-600 text-white rounded-lg hover:bg-green-700 transition-colors duration-200">
                            Sign Up
                        </a>
                    <?php endif; ?>
                </div>
    ...
    <footer class="relative z-10 bg-green-900/80 backdrop-blur-sm mt-16 py-12 border-t border-green-800">
        <div class="container mx-auto px-4 lg:px-16">
            ...
            <div class="text-center pt-8 border-t border-green-800">
                <p class="text-gray-300">&copy; <?php echo e(date('Y')); ?> Vales Beach Resort. All rights reserved.</p>
            </div>
        </div>
    </footer>
</body>
</html>
<?php /**PATH C:\xampp\htdocs\VALESBEACH_LATEST\ValesBeach\resources\views/welcome.blade.php ENDPATH**/ ?>