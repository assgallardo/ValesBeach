    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="bg-white text-gray-900 rounded-lg overflow-hidden" id="invoice-content">
            ...
            <div class="p-6">
                ...
                <!-- Payment Information -->
                <?php if($invoice->booking_id && $invoice->booking && $invoice->booking->payments->count() > 0): ?>
...
<?php echo $__env->make(auth()->user()->role === 'admin' ? 'layouts.admin' : (auth()->user()->role === 'manager' ? 'layouts.manager' : (auth()->user()->role === 'staff' ? 'layouts.staff' : 'layouts.guest')), array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\valesbeachresort\ValesBeach\resources\views/invoices/show.blade.php ENDPATH**/ ?>