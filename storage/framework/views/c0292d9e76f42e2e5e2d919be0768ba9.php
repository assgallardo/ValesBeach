            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div class="lg:col-span-2">
                    <div class="bg-green-900/50 backdrop-blur-sm rounded-lg p-8 mb-8">
                        ...
                        <div class="mt-6">
                            <label class="block text-green-200 text-sm font-medium mb-3">Special Timing Requests</label>
                            <div class="space-y-3">
                                <?php if($booking->early_checkin): ?>
                                <div class="bg-green-800/30 border border-green-700 rounded-lg p-4">
                                    <div class="flex items-center justify-between">
                                        <div class="flex items-center">
                                            ...
                                            <div>
                                                <p class="text-green-50 font-medium">Early Check-in Requested</p>
                                                <?php if($booking->room->check_in_time): ?>
                                                <p class="text-green-300 text-sm">Before <?php echo e(\Carbon\Carbon::parse($booking->room->check_in_time)->format('g:i A')); ?></p>
                                                <?php endif; ?>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="bg-yellow-800/30 border border-yellow-700 rounded-lg p-4">
                                    <div class="flex items-center justify-between">
                                        <div class="flex items-center">
                                            ...
                                            <div>
                                                <p class="text-green-50 font-medium">Late Check-out Requested</p>
                                                <?php if($booking->room->check_out_time): ?>
                                                <p class="text-yellow-300 text-sm">After <?php echo e(\Carbon\Carbon::parse($booking->room->check_out_time)->format('g:i A')); ?></p>
                                                <?php endif; ?>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="bg-green-800/50 rounded-lg p-4 border-l-4 
                                    ...
                                    <div class="flex justify-between items-start mb-3">
                                        ...
                                        <span class="px-3 py-1 rounded-full text-xs font-medium
                                            ...
                                            <?php elseif($payment->status === 'refunded'): ?> bg-red-100 text-red-800
                                            <?php else: ?> bg-gray-100 text-gray-800
                                            <?php endif; ?>">
