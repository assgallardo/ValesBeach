...
<div class="container mx-auto px-4 lg:px-8 py-8">
    ...
    <!-- Tabs for Room/Cottage/Event/All Bookings -->
    <div x-data="{ activeTab: '<?php echo e(request('type', 'all')); ?>' }" class="mb-8">
        <!-- Tab Navigation -->
        <div class="bg-gray-800 rounded-t-lg">
            <div class="flex border-b border-gray-700 overflow-x-auto">
                <button @click="activeTab = 'all'; window.location.href = '<?php echo e(route('manager.bookings.index', ['type' => 'all'] + request()->except('type'))); ?>'" 
                ...
                <button @click="activeTab = 'room'; window.location.href = '<?php echo e(route('manager.bookings.index', ['type' => 'room'] + request()->except('type'))); ?>'" 
                ...
                <button @click="activeTab = 'cottage'; window.location.href = '<?php echo e(route('manager.bookings.index', ['type' => 'cottage'] + request()->except('type'))); ?>'" 
                ...
                <button @click="activeTab = 'event'; window.location.href = '<?php echo e(route('manager.bookings.index', ['type' => 'event'] + request()->except('type'))); ?>'" 
                ...
                <table class="w-full text-left">
                    ...
                    <tbody class="divide-y divide-gray-700">
                        ...
                        <tr class="hover:bg-gray-700 transition-colors" id="booking-row-<?php echo e($booking->id); ?>">
                            ...
                            <td class="px-6 py-4">
                                <div class="text-green-400 font-semibold">₱<?php echo e(number_format((float)$booking->total_price, 2)); ?></div>
                            </td>
                            <td class="px-6 py-4">
        ...
        <div x-show="activeTab === 'cottage'" class="bg-gray-800 rounded-b-lg shadow-xl overflow-hidden">
            <div class="overflow-x-auto">
                <table class="w-full text-left">
                    ...
                    <tbody class="divide-y divide-gray-700">
                        <?php $__empty_1 = true; $__currentLoopData = $cottageBookings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cottageBooking): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr class="hover:bg-gray-700 transition-colors" id="cottage-booking-row-<?php echo e($cottageBooking->id); ?>">
                            ...
                            <td class="px-6 py-4 booking-dates">
                                ...
                                <div class="text-sm text-gray-400"><?php echo e($cottageBooking->check_in->format('l \a\t g:i A')); ?></div>
                                <div class="text-white mt-1"><?php echo e($cottageBooking->check_out->format('M d, Y')); ?></div>
                                <div class="text-sm text-gray-400"><?php echo e($cottageBooking->check_out->format('l \a\t g:i A')); ?></div>
                            </td>
                            <td class="px-6 py-4">
                                <div class="text-green-400 font-semibold booking-total">₱<?php echo e(number_format((float)$cottageBooking->total_price, 2)); ?></div>
                                <div class="text-sm text-gray-400 booking-nights">
                                    <?php echo e($cottageBooking->check_in->diffInDays($cottageBooking->check_out)); ?> night(s)
                                </div>
                            </td>
                            <td class="px-6 py-4">
                                <span class="px-3 py-1 rounded-full text-xs font-medium booking-status
                            ...
                            <td class="px-6 py-4">
                                <div class="flex items-center space-x-3">
                                    <!-- View Details -->
                                    <a href="<?php echo e(route('manager.bookings.show', $cottageBooking)); ?>" 
                                       class="text-blue-400 hover:text-blue-300 transition-colors" title="View Details">
                                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"/>
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z"/>
        ...
        <div x-show="activeTab === 'event'" class="bg-gray-800 rounded-b-lg shadow-xl overflow-hidden">
            <div class="overflow-x-auto">
                <table class="w-full text-left">
                    ...
                    <tbody class="divide-y divide-gray-700">
                        <?php $__empty_1 = true; $__currentLoopData = $eventDiningBookings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $eventBooking): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr class="hover:bg-gray-700 transition-colors" id="event-booking-row-<?php echo e($eventBooking->id); ?>">
                            <td class="px-6 py-4">
                                <div class="text-white font-medium">#<?php echo e($eventBooking->id); ?></div>
                            ...
                            <td class="px-6 py-4">
                                <span class="px-2 py-1 text-xs font-medium rounded-full 
                                    <?php echo e($eventBooking->room->category === 'Rooms' ? 'bg-blue-900 text-blue-200' : ''); ?>

                                    <?php echo e($eventBooking->room->category === 'Cottages' ? 'bg-purple-900 text-purple-200' : ''); ?>

                                    <?php echo e($eventBooking->room->category === 'Event and Dining' ? 'bg-pink-900 text-pink-200' : ''); ?>">
                                    <?php echo e($eventBooking->room->category ?? 'N/A'); ?>

                                </span>
                            </td>
                            <td class="px-6 py-4 booking-dates">
                                <div class="text-white"><?php echo e($eventBooking->check_in->format('M d, Y')); ?></div>
                                <div class="text-sm text-gray-400"><?php echo e($eventBooking->check_in->format('l \a\t g:i A')); ?></div>
                                <div class="text-white mt-1"><?php echo e($eventBooking->check_out->format('M d, Y')); ?></div>
                                <div class="text-sm text-gray-400"><?php echo e($eventBooking->check_out->format('l \a\t g:i A')); ?></div>
                            </td>
                            <td class="px-6 py-4">
                                <div class="text-green-400 font-semibold booking-total">₱<?php echo e(number_format((float)$eventBooking->total_price, 2)); ?></div>
                                <div class="text-sm text-gray-400 booking-nights">
                                    <?php echo e($eventBooking->check_in->diffInDays($eventBooking->check_out)); ?> night(s)
                                </div>
                            </td>
                            <td class="px-6 py-4">
                                <span class="px-3 py-1 rounded-full text-xs font-medium booking-status
                            ...
                            <td class="px-6 py-4">
                                <div class="flex items-center space-x-3">
                                    <!-- View Details -->
                                    <a href="<?php echo e(route('manager.bookings.show', $eventBooking)); ?>" 
                                       class="text-blue-400 hover:text-blue-300 transition-colors" title="View Details">
                                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"/>
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z"/>
...
<?php echo $__env->make('layouts.manager', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\sethy\ValesBeach\resources\views/manager/bookings/index.blade.php ENDPATH**/ ?>