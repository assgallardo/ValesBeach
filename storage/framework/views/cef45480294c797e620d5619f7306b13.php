        ...
        <div class="mb-8">
            <div class="flex items-center justify-between mb-2">
                <div class="flex items-center gap-3">
                    <a href="<?php echo e(route('admin.payments.completed')); ?>" 
                ...
                <div class="flex items-center gap-3">
                    <form method="POST" action="<?php echo e(route('admin.payments.customer.revert', $customer->id)); ?>" 
                          onsubmit="return confirm('Are you sure you want to revert this payment transaction for <?php echo e($customer->name); ?> back to confirmed status? This will move it back to the Payment Management view.')">
                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\VALESBEACH_LATEST\ValesBeach\resources\views/admin/payments/completed-customer.blade.php ENDPATH**/ ?>