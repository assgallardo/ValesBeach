...
<div class="max-w-5xl mx-auto">
    ...
    <div class="bg-gray-800 rounded-lg shadow-xl overflow-hidden">
        ...
        <div class="p-8">
            <!-- Service Name -->
            <div class="mb-6">
                <h2 class="text-4xl font-bold text-white mb-2"><?php echo e($service->name); ?></h2>
                <div class="flex items-center space-x-4 text-sm text-gray-400">
                    <span class="flex items-center">
                        <svg class="w-4 h-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"/>
                        </svg>
                        Created <?php echo e($service->created_at->format('M d, Y')); ?>
                    ...
                    <span class="flex items-center">
                        ...
                        Updated <?php echo e($service->updated_at->format('M d, Y')); ?>
            ...
            <div class="bg-gray-700 rounded-lg p-6 mb-6">
                ...
                <p class="text-gray-300 leading-relaxed"><?php echo e($service->description); ?></p>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
                <div class="bg-gray-700 rounded-lg p-5">
                    ...
                    <p class="text-white text-lg font-semibold"><?php echo e(ucfirst(str_replace('_', ' ', $service->category))); ?></p>
                </div>
                ...
                <div class="bg-gray-700 rounded-lg p-5">
                    ...
                    <p class="text-white text-lg font-semibold"><?php echo e($service->capacity); ?> <?php echo e($service->capacity === 1 ? 'person' : 'people'); ?></p>
                </div>
                <?php endif; ?>
                ...
                <div class="bg-gray-700 rounded-lg p-5">
                    ...
                    <p class="text-white text-lg font-semibold">₱<?php echo e(number_format($service->price, 2)); ?></p>
                </div>
            </div>
            ...
            <div class="flex flex-wrap gap-3 pt-6 border-t border-gray-700">
                ...
                <form action="<?php echo e(route('manager.services.toggle-status', $service)); ?>" method="POST" class="inline">
                    ...
                    <button type="submit" 
                            class="inline-flex items-center px-6 py-3 font-semibold rounded-lg shadow-lg transition-all duration-200 transform hover:scale-105 <?php echo e($service->is_available ? 'bg-yellow-600 hover:bg-yellow-700 text-white' : 'bg-blue-600 hover:bg-blue-700 text-white'); ?>">
                        <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\VALESBEACH_LATEST\ValesBeach\resources\views/manager/services/show.blade.php ENDPATH**/ ?>