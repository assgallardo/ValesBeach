        ...
        <div class="bg-gray-800 rounded-lg shadow-xl overflow-hidden">
            ...
            <div class="p-6 grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="space-y-6">
                    ...
                    <?php if((!empty($room->check_in_time) && $room->check_in_time !== '00:00:00') || (!empty($room->check_out_time) && $room->check_out_time !== '00:00:00')): ?>
                    <div>
                        <h4 class="text-lg font-semibold text-white mb-2">Check-in / Check-out Time</h4>
                        <p class="text-gray-300">
                            <?php if(!empty($room->check_in_time) && $room->check_in_time !== '00:00:00'): ?>
                                Check-in: <?php echo e(\Carbon\Carbon::createFromFormat('H:i:s', $room->check_in_time)->format('g:i A')); ?><br>
                            <?php endif; ?>
                            <?php if(!empty($room->check_out_time) && $room->check_out_time !== '00:00:00'): ?>
            ...
            <div class="p-6 border-t border-gray-700">
                ...
                <div class="mb-6">
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        <?php $__empty_1 = true; $__currentLoopData = $room->images; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $image): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
...
<?php echo $__env->make('layouts.manager', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\VALESBEACH_LATEST\ValesBeach\resources\views/manager/rooms/show.blade.php ENDPATH**/ ?>