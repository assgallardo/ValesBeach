                        ...
                        <div class="p-6">
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <a href="<?php echo e(route('manager.bookings.show', $payment->booking)); ?>" 
                                ...
                                <div>
                                    ...
                                    <div class="text-gray-300">
                                        <?php if($payment->booking->room): ?>
                                            <?php echo e($payment->booking->room->name); ?> - Room <?php echo e($payment->booking->room->room_number); ?>
            ...
            <div class="space-y-6">
                    ...
                    <div class="p-6">
                        ...
                        <div class="space-y-4">
                            ...
                            <div>
                                ...
                                <div class="text-gray-300"><?php echo e($payment->user->payments->count()); ?> payments</div>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <?php if(in_array($payment->status, ['pending', 'processing'])): ?>
                    <div class="bg-gray-800 rounded-lg border border-gray-700 overflow-hidden">
                        ...
                        <div class="p-6">
                            <form method="POST" action="<?php echo e(route('manager.payments.updateStatus', $payment)); ?>" class="space-y-4">
                                <?php echo csrf_field(); ?>
                                ...
                                <div>
                                    ...
                                    <textarea name="notes" id="notes" rows="3" 
                                              ...
                                              class="w-full bg-gray-900 border border-gray-600 rounded-lg px-3 py-2 text-gray-300 focus:outline-none focus:border-green-500"><?php echo e($payment->notes); ?></textarea>
                                </div>
                        ...
                        <div class="space-y-4">
                            <div class="flex items-start">
                                ...
                                <div class="flex-1">
                                    ...
                                    <div class="text-xs text-gray-500">By: <?php echo e($payment->user->name); ?></div>
                                </div>
                            </div>
...
<?php echo $__env->make('layouts.manager', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\sethy\ValesBeach\resources\views\manager\payments\show.blade.php ENDPATH**/ ?>