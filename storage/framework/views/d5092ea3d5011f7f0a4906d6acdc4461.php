            ...
            <div class="overflow-x-auto">
                <table class="w-full">
                    ...
                    <tbody class="divide-y divide-gray-700">
                        ...
                        <?php $__empty_0 = true; $__currentLoopData = $allCustomers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $customer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_0 = false; ?>
                        <?php
                        ...
                        ?>
                        <tr class="hover:bg-gray-700/50 transition-colors <?php echo e($isRepeatCustomer ? 'bg-cyan-900/10 border-l-4 border-cyan-500' : ''); ?>">
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="flex items-center">
                                    <div class="w-10 h-10 <?php echo e($isRepeatCustomer ? 'bg-cyan-600/20' : 'bg-blue-600/20'); ?> rounded-full flex items-center justify-center mr-3">
                                        <i class="fas <?php echo e($isRepeatCustomer ? 'fa-user-check text-cyan-400' : 'fa-user text-blue-400'); ?>"></i>
                                    </div>
                                    <div>
                                        <div class="text-white font-medium"><?php echo e($customer->name); ?></div>
                                        <?php if($isRepeatCustomer): ?>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <span class="px-3 py-1 <?php echo e($isRepeatCustomer ? 'bg-cyan-900/30 text-cyan-400 border-cyan-600/30' : 'bg-blue-900/30 text-blue-400 border-blue-600/30'); ?> text-sm font-semibold rounded-full border">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-gray-400 text-sm">
                                <?php echo e($lastBooking ? $lastBooking->created_at->format('M d, Y') : 'N/A'); ?>
        ...
        <div class="bg-gray-800 rounded-lg border border-gray-700 overflow-hidden">
            ...
            <div class="overflow-x-auto">
                <table class="w-full">
                    ...
                    <tbody class="divide-y divide-gray-700">
                        <?php $__empty_0 = true; $__currentLoopData = $repeatCustomers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $customer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_0 = false; ?>
                        <?php
                        ...
                        <tr class="hover:bg-gray-700/50 transition-colors bg-cyan-900/10 border-l-4 border-cyan-500">
                            ...
                            <td class="px-6 py-4">
                                <div class="flex flex-wrap gap-1">
                                    <?php $__empty_1 = true; $__currentLoopData = $customerPaymentMethods; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $method): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\sethy\ValesBeach\resources\views\manager\reports\repeat-customers.blade.php ENDPATH**/ ?>