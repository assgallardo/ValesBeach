...
<div class="container mx-auto px-4 lg:px-16 py-8">
    <!-- Back Button -->
    <div class="mb-6">
        <a href="<?php echo e(route('admin.bookings')); ?>" class="inline-flex items-center text-green-100 hover:text-green-200">
        ...
        <div class="bg-gray-800 rounded-lg p-6">
            ...
            <div class="space-y-4">
                ...
                <div>
                    ...
                    <p class="text-green-50">₱<?php echo e(number_format($booking->room->price_per_night, 2)); ?></p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-gray-800 rounded-lg p-6">
            ...
            <div class="space-y-4">
                <div>
                    ...
                    <p class="text-green-50"><?php echo e($booking->check_in->format('F d, Y')); ?></p>
                </div>
                <div>
                    <label class="text-sm text-green-200">Check-out Date</label>
                    <p class="text-green-50"><?php echo e($booking->check_out->format('F d, Y')); ?></p>
                </div>
                <div>
        ...
        <div class="bg-gray-800 rounded-lg p-6">
            ...
            <div class="space-y-4">
                <div>
                    ...
                    <p class="text-green-50 text-lg font-semibold"><?php echo e($booking->formatted_total_price); ?></p>
                </div>
                <div>
