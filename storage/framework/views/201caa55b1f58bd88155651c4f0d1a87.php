<?php $__env->startSection('title', 'Room Booking Sales Report'); ?>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6 mb-8">
            <div class="bg-gray-800 rounded-lg border border-gray-700 p-6 text-center">
                ...
                <h2 class="text-3xl font-bold text-green-50 mb-2"><?php echo e(number_format($stats['total_bookings'])); ?></h2>
            ...
            <div class="bg-gray-800 rounded-lg border border-gray-700 p-6 text-center">
                ...
                <h2 class="text-3xl font-bold text-green-50 mb-2"><?php echo e(number_format($stats['completed_bookings'])); ?></h2>
            ...
            <div class="bg-gray-800 rounded-lg border border-gray-700 p-6 text-center">
                ...
                <h2 class="text-3xl font-bold text-green-50 mb-2"><?php echo e(number_format($stats['cancelled_bookings'])); ?></h2>
            ...
            <div class="bg-gray-800 rounded-lg border border-gray-700 p-6 text-center">
                ...
                <h2 class="text-3xl font-bold text-green-50 mb-2">₱<?php echo e(number_format($stats['avg_booking_value'] ?? 0, 2)); ?></h2>
            ...
            <div class="overflow-x-auto">
                <table class="w-full">
                    ...
                    <tbody class="divide-y divide-gray-700">
                        <?php $__empty_1 = true; $__currentLoopData = $revenueByRooms; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $room): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr class="hover:bg-gray-700/50">
                            <td class="px-6 py-4">
                                <div class="flex items-center">
                                    ...
                                    <span class="text-gray-200"><?php echo e($room->name); ?></span>
                                </div>
                            </td>
                            <td class="px-6 py-4 text-gray-300"><?php echo e(number_format($room->booking_count)); ?></td>
                            <td class="px-6 py-4 text-green-400 font-semibold">₱<?php echo e(number_format($room->total_revenue ?? 0, 2)); ?></td>
                            <td class="px-6 py-4 text-gray-300">₱<?php echo e(number_format(($room->total_revenue ?? 0) / max($room->booking_count, 1), 2)); ?></td>
                        </tr>
        ...
        <div class="bg-gray-800 rounded-lg border border-gray-700 overflow-hidden mb-8">
            ...
            <div class="overflow-x-auto">
                <table class="w-full">
                    ...
                    <tbody class="divide-y divide-gray-700">
                        <?php $__empty_1 = true; $__currentLoopData = $revenueByCottages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cottage): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr class="hover:bg-gray-700/50">
                            <td class="px-6 py-4">
                                <div class="flex items-center">
                                    ...
                                    <span class="text-gray-200"><?php echo e($cottage->name); ?></span>
                                </div>
                            </td>
                            <td class="px-6 py-4 text-gray-300"><?php echo e(number_format($cottage->booking_count)); ?></td>
                            <td class="px-6 py-4 text-green-400 font-semibold">₱<?php echo e(number_format($cottage->total_revenue ?? 0, 2)); ?></td>
                            <td class="px-6 py-4 text-gray-300">₱<?php echo e(number_format(($cottage->total_revenue ?? 0) / max($cottage->booking_count, 1), 2)); ?></td>
                        </tr>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                        <tr>
                            <td colspan="4" class="px-6 py-8 text-center text-gray-400">
        ...
        <div class="bg-gray-800 rounded-lg border border-gray-700 overflow-hidden mb-8">
            ...
            <div class="overflow-x-auto">
                <table class="w-full">
                    ...
                    <tbody class="divide-y divide-gray-700">
                        <?php $__empty_1 = true; $__currentLoopData = $revenueByEventDining; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $facility): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr class="hover:bg-gray-700/50">
                            <td class="px-6 py-4">
                                <div class="flex items-center">
                                    ...
                                    <span class="text-gray-200"><?php echo e($facility->name); ?></span>
                                </div>
                            </td>
                            <td class="px-6 py-4 text-gray-300"><?php echo e(number_format($facility->booking_count)); ?></td>
                            <td class="px-6 py-4 text-green-400 font-semibold">₱<?php echo e(number_format($facility->total_revenue ?? 0, 2)); ?></td>
                            <td class="px-6 py-4 text-gray-300">₱<?php echo e(number_format(($facility->total_revenue ?? 0) / max($facility->booking_count, 1), 2)); ?></td>
                        </tr>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                        <tr>
                            <td colspan="4" class="px-6 py-8 text-center text-gray-400">
                ...
                <div class="bg-gradient-to-br from-gray-800 via-gray-800 to-gray-900 rounded-2xl border border-yellow-600/30 overflow-hidden shadow-2xl sticky top-6">
                    ...
                    <div class="p-6 space-y-6">
                        ...
                        <div>
                            ...
                            <?php $__empty_1 = true; $__currentLoopData = $topRooms; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $room): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <div class="flex items-center mb-3 group hover:bg-gray-700/30 rounded-lg p-2 transition-all duration-200 <?php echo e($index === 0 ? 'bg-yellow-500/10' : ''); ?>">
                                    <div class="relative">
                                        <?php if($index === 0): ?>
                                    ...
                                    <div class="flex-1 min-w-0">
                                        <p class="text-gray-200 font-medium text-sm truncate"><?php echo e($room->name); ?></p>
                                        <div class="flex items-center text-xs text-gray-400 mt-0.5">
                                            <i class="fas fa-calendar-check mr-1"></i>
                                            <span><?php echo e(number_format($room->booking_count)); ?> booking<?php echo e($room->booking_count != 1 ? 's' : ''); ?></span>
                                        </div>
                                    </div>
                                    <?php if($index === 0): ?>
                        ...
                        <div>
                            ...
                            <?php $__empty_1 = true; $__currentLoopData = $topCottages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $cottage): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <div class="flex items-center mb-3 group hover:bg-gray-700/30 rounded-lg p-2 transition-all duration-200 <?php echo e($index === 0 ? 'bg-yellow-500/10' : ''); ?>">
                                    <div class="relative">
                                        <?php if($index === 0): ?>
                                            <div class="w-12 h-12 bg-gradient-to-br from-yellow-400 to-yellow-600 rounded-full flex items-center justify-center mr-3 ring-4 ring-yellow-400/30 shadow-lg">
                                    ...
                                    <div class="flex-1 min-w-0">
                                        <p class="text-gray-200 font-medium text-sm truncate"><?php echo e($cottage->name); ?></p>
                                        <div class="flex items-center text-xs text-gray-400 mt-0.5">
                                            <i class="fas fa-calendar-check mr-1"></i>
                                            <span><?php echo e(number_format($cottage->booking_count)); ?> booking<?php echo e($cottage->booking_count != 1 ? 's' : ''); ?></span>
                                        </div>
                                    </div>
                                    <?php if($index === 0): ?>
                                        <i class="fas fa-sparkles text-yellow-400 text-lg ml-2"></i>
                        ...
                        <div>
                            ...
                            <?php $__empty_1 = true; $__currentLoopData = $topEventDining; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $facility): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <div class="flex items-center mb-3 group hover:bg-gray-700/30 rounded-lg p-2 transition-all duration-200 <?php echo e($index === 0 ? 'bg-yellow-500/10' : ''); ?>">
                                    <div class="relative">
                                        <?php if($index === 0): ?>
                                            <div class="w-12 h-12 bg-gradient-to-br from-yellow-400 to-yellow-600 rounded-full flex items-center justify-center mr-3 ring-4 ring-yellow-400/30 shadow-lg">
                                    ...
                                    <div class="flex-1 min-w-0">
                                        <p class="text-gray-200 font-medium text-sm truncate"><?php echo e($facility->name); ?></p>
                                        <div class="flex items-center text-xs text-gray-400 mt-0.5">
                                            <i class="fas fa-calendar-check mr-1"></i>
                                            <span><?php echo e(number_format($facility->booking_count)); ?> booking<?php echo e($facility->booking_count != 1 ? 's' : ''); ?></span>
                                        </div>
                                    </div>
                                    <?php if($index === 0): ?>
                                        <i class="fas fa-sparkles text-yellow-400 text-lg ml-2"></i>
                        ...
                        <tr class="hover:bg-gray-700/50">
                            <td class="px-6 py-4">
                                <span class="px-3 py-1 rounded-full text-xs font-medium
                                    <?php echo e($status->status === 'pending' ? 'bg-yellow-100 text-yellow-800' : ''); ?>

                                    <?php echo e($status->status === 'confirmed' ? 'bg-green-100 text-green-800' : ''); ?>

                                    <?php echo e($status->status === 'checked_in' ? 'bg-blue-100 text-blue-800' : ''); ?>

                                    <?php echo e($status->status === 'checked_out' ? 'bg-gray-100 text-gray-800' : ''); ?>

                                    <?php echo e($status->status === 'cancelled' ? 'bg-red-100 text-red-800' : ''); ?>

                                    <?php echo e($status->status === 'completed' ? 'bg-purple-100 text-purple-800' : ''); ?>
                            ...
                            <td class="px-6 py-4 text-gray-300"><?php echo e(number_format(($status->count / max($stats['total_bookings'], 1)) * 100, 1)); ?>%</td>
                        </tr>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                        <tr>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\VALESBEACH_LATEST\ValesBeach\resources\views/manager/reports/room-sales.blade.php ENDPATH**/ ?>