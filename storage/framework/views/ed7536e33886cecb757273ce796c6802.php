...
<div class="container mx-auto px-4 lg:px-16 py-8">
    ...
    <div class="bg-gray-800 rounded-lg overflow-hidden shadow-lg mb-6">
        <?php if($cottage->primary_image_url): ?>
            <img src="<?php echo e($cottage->primary_image_url); ?>" alt="<?php echo e($cottage->name); ?>" class="w-full h-64 md:h-96 object-cover">
        <?php else: ?>
        ...
        <div class="p-6">
            <div class="flex items-center justify-between mb-4">
                <h1 class="text-3xl font-bold text-white"><?php echo e($cottage->name); ?></h1>
                <?php if($cottage->is_featured): ?>
                    <span class="bg-yellow-500 text-yellow-900 px-3 py-1 rounded-full font-semibold">
                        ⭐ Featured
                    </span>
                <?php endif; ?>
            </div>
            <p class="text-gray-300 text-lg"><?php echo e($cottage->description); ?></p>
        </div>
    </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="lg:col-span-2 space-y-6">
            ...
            <div class="bg-gray-800 rounded-lg p-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div class="bg-gray-700 p-4 rounded-lg">
                        ...
                        <p class="text-2xl font-bold text-green-400"><?php echo e($cottage->formatted_price_per_day); ?></p>
                        <p class="text-gray-500 text-xs">6:00 AM - 6:00 PM</p>
                    </div>
                    <?php if($cottage->price_per_hour): ?>
                    <div class="bg-gray-700 p-4 rounded-lg">
                        <p class="text-gray-400 text-sm">Hourly Rate</p>
                        <p class="text-2xl font-bold text-blue-400"><?php echo e($cottage->formatted_price_per_hour); ?></p>
                        <p class="text-gray-500 text-xs">Min <?php echo e($cottage->min_hours); ?> hrs, Max <?php echo e($cottage->max_hours); ?> hrs</p>
                    </div>
                    <?php endif; ?>
                    <?php if($cottage->weekend_rate && $cottage->weekend_rate > $cottage->price_per_day): ?>
                    <div class="bg-gray-700 p-4 rounded-lg">
                        <p class="text-gray-400 text-sm">Weekend Rate</p>
                        <p class="text-2xl font-bold text-purple-400">₱<?php echo e(number_format($cottage->weekend_rate, 2)); ?></p>
            ...
            <div class="bg-gray-800 rounded-lg p-6">
                ...
                <div class="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
                    ...
                    <div class="text-center">
                        <div class="bg-gray-700 rounded-lg p-4">
                            ...
                            <p class="text-white font-bold"><?php echo e($cottage->bathrooms); ?></p>
                            <p class="text-gray-400 text-sm">Bathrooms</p>
                        </div>
                    </div>
                    <?php endif; ?>
                    <?php if($cottage->size_sqm): ?>
                    <div class="text-center">
                        <div class="bg-gray-700 rounded-lg p-4">
                            ...
                            <p class="text-white font-bold"><?php echo e($cottage->size_sqm); ?></p>
                ...
                <?php if($cottage->amenities && count($cottage->amenities) > 0): ?>
                <div class="mb-4">
                    <h3 class="text-white font-semibold mb-3">Amenities</h3>
                    <div class="grid grid-cols-2 md:grid-cols-3 gap-2">
                        <?php $__currentLoopData = $cottage->amenities; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $amenity): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <?php if($cottage->features && count($cottage->features) > 0): ?>
                <div>
                    <h3 class="text-white font-semibold mb-3">Features</h3>
                    <div class="flex flex-wrap gap-2">
                        <?php $__currentLoopData = $cottage->features; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $feature): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            <div class="bg-gray-800 rounded-lg p-6">
                ...
                <?php if($cottage->location): ?>
                <div class="mb-4">
                    <h3 class="text-white font-semibold mb-2">Location</h3>
                    <p class="text-gray-300"><?php echo e($cottage->location); ?></p>
                </div>
                <?php endif; ?>
                <div class="grid grid-cols-2 gap-4">
                    <div>
                        <p class="text-gray-400 text-sm">Day Use</p>
                        <p class="text-white"><?php echo e($cottage->allow_day_use ? '✓ Allowed' : '✗ Not Available'); ?></p>
                    </div>
                    <div>
                        <p class="text-gray-400 text-sm">Overnight Stay</p>
                        <p class="text-white"><?php echo e($cottage->allow_overnight ? '✓ Allowed' : '✗ Not Available'); ?></p>
                    </div>
                    <div>
                        <p class="text-gray-400 text-sm">Pets</p>
                        <p class="text-white"><?php echo e($cottage->allow_pets ? '✓ Allowed' : '✗ Not Allowed'); ?></p>
                    </div>
                    <div>
                        <p class="text-gray-400 text-sm">Events</p>
                        <p class="text-white"><?php echo e($cottage->allow_events ? '✓ Allowed' : '✗ Not Allowed'); ?></p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="bg-gray-800 rounded-lg p-6 sticky top-4">
                ...
                <div class="space-y-3 mb-6">
                    <div class="flex justify-between">
                        ...
                        <span class="text-2xl font-bold text-green-400"><?php echo e($cottage->formatted_price_per_day); ?></span>
                    </div>
                    <?php if($cottage->security_deposit): ?>
                    <div class="flex justify-between text-sm">
                        <span class="text-gray-400">Security Deposit</span>
                        <span class="text-gray-300">₱<?php echo e(number_format($cottage->security_deposit, 2)); ?></span>
                    </div>
                    <?php endif; ?>
                </div>

                <a href="<?php echo e(route('guest.cottages.book', $cottage)); ?>" 
                ...
                <a href="<?php echo e(route('guest.cottages.index')); ?>" 
...
<?php echo $__env->make('layouts.guest', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\sethy\ValesBeach\resources\views\guest\cottages\show.blade.php ENDPATH**/ ?>