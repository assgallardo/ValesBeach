            ...
            <div class="overflow-x-auto">
                <table class="w-full">
                    ...
                    <tbody class="divide-y divide-gray-700">
                        ...
                        ?>
                        <?php $__empty_0 = true; $__currentLoopData = $paymentMethodStats; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $method): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_0 = false; ?>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div class="bg-gray-800 rounded-lg border border-gray-700 overflow-hidden">
                ...
                <div class="p-4 space-y-3">
                    <?php $__empty_0 = true; $__currentLoopData = $paymentsBySource['bookings']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $payment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_0 = false; ?>
            ...
            <div class="bg-gray-800 rounded-lg border border-gray-700 overflow-hidden">
                ...
                <div class="p-4 space-y-3">
                    <?php $__empty_0 = true; $__currentLoopData = $paymentsBySource['food_orders']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $payment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_0 = false; ?>
                    <div class="flex justify-between items-center">
                        <span class="text-gray-300 text-sm"><?php echo e(ucwords(str_replace('_', ' ', $payment->payment_method))); ?></span>
            ...
            <div class="bg-gray-800 rounded-lg border border-gray-700 overflow-hidden">
                ...
                <div class="p-4 space-y-3">
                    <?php $__empty_0 = true; $__currentLoopData = $paymentsBySource['services']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $payment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_0 = false; ?>
                    <div class="flex justify-between items-center">
                        <span class="text-gray-300 text-sm"><?php echo e(ucwords(str_replace('_', ' ', $payment->payment_method))); ?></span>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\sethy\ValesBeach\resources\views\manager\reports\payment-methods.blade.php ENDPATH**/ ?>