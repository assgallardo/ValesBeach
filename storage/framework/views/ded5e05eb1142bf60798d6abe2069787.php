                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <div class="border-2 border-dashed border-gray-600 rounded-lg p-4 text-center hover:border-green-500 transition-colors duration-200">
                            ...
                            <?php endif; ?>
                            <div id="uploadPlaceholder" class="<?php echo e($service->image ? 'hidden' : ''); ?>">
                                <input type="file" 
                                       id="image" 
                                       name="image" 
                                       accept="image/*"
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\sethy\ValesBeach\resources\views\manager\services\edit.blade.php ENDPATH**/ ?>