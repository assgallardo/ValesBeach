            ...
            <div class="overflow-x-auto">
                <table class="w-full">
                    ...
                    <tbody class="divide-y divide-gray-700">
                        <?php $__empty_0 = true; $__currentLoopData = $revenueByRooms; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $room): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_0 = false; ?>
        ...
        <div class="bg-gray-800 rounded-lg border border-gray-700 overflow-hidden mb-8">
            ...
            <div class="overflow-x-auto">
                <table class="w-full">
                    ...
                    <tbody class="divide-y divide-gray-700">
                        <?php $__empty_0 = true; $__currentLoopData = $revenueByCottages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cottage): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_0 = false; ?>
                        <tr class="hover:bg-gray-700/50">
                            <td class="px-6 py-4">
                                <div class="flex items-center">
        ...
        <div class="bg-gray-800 rounded-lg border border-gray-700 overflow-hidden mb-8">
            ...
            <div class="overflow-x-auto">
                <table class="w-full">
                    ...
                    <tbody class="divide-y divide-gray-700">
                        <?php $__empty_0 = true; $__currentLoopData = $revenueByEventDining; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $facility): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_0 = false; ?>
                        <tr class="hover:bg-gray-700/50">
                            <td class="px-6 py-4">
                                <div class="flex items-center">
                ...
                <div class="bg-gradient-to-br from-gray-800 via-gray-800 to-gray-900 rounded-2xl border border-yellow-600/30 overflow-hidden shadow-2xl sticky top-6">
                    ...
                    <div class="p-6 space-y-6">
                        ...
                        <div>
                            ...
                            <?php $__empty_0 = true; $__currentLoopData = $topRooms; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $room): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_0 = false; ?>
                        ...
                        <div>
                            ...
                            <?php $__empty_0 = true; $__currentLoopData = $topCottages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $cottage): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_0 = false; ?>
                                <div class="flex items-center mb-3 group hover:bg-gray-700/30 rounded-lg p-2 transition-all duration-200 <?php echo e($index === 0 ? 'bg-yellow-500/10' : ''); ?>">
                                    <div class="relative">
                                        <?php if($index === 0): ?>
                                            <div class="w-12 h-12 bg-gradient-to-br from-yellow-400 to-yellow-600 rounded-full flex items-center justify-center mr-3 ring-4 ring-yellow-400/30 shadow-lg">
                        ...
                        <div>
                            ...
                            <?php $__empty_0 = true; $__currentLoopData = $topEventDining; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $facility): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_0 = false; ?>
                                <div class="flex items-center mb-3 group hover:bg-gray-700/30 rounded-lg p-2 transition-all duration-200 <?php echo e($index === 0 ? 'bg-yellow-500/10' : ''); ?>">
                                    <div class="relative">
                                        <?php if($index === 0): ?>
                                            <div class="w-12 h-12 bg-gradient-to-br from-yellow-400 to-yellow-600 rounded-full flex items-center justify-center mr-3 ring-4 ring-yellow-400/30 shadow-lg">
        ...
        <div class="bg-gray-800 rounded-lg border border-gray-700 overflow-hidden mb-8">
            ...
            <div class="overflow-x-auto">
                <table class="w-full">
                    ...
                    <tbody class="divide-y divide-gray-700">
                        <?php $__empty_0 = true; $__currentLoopData = $statusBreakdown; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $status): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_0 = false; ?>
                        <tr class="hover:bg-gray-700/50">
                            <td class="px-6 py-4">
                                <span class="px-3 py-1 rounded-full text-xs font-medium
                                    ...
                                    <?php echo e($status->status === 'confirmed' ? 'bg-blue-600/20 text-blue-400' : ''); ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\sethy\ValesBeach\resources\views\manager\reports\room-sales.blade.php ENDPATH**/ ?>