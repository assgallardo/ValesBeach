    ...
    <div class="max-w-4xl mx-auto">
        <div class="bg-gray-800 rounded-lg p-6 mb-6">
            <div class="flex items-center justify-between mb-4">
                ...
                <span class="px-4 py-2 rounded-full text-sm font-semibold <?php echo e($booking->status_color); ?>">
                    <?php echo e(ucfirst($booking->status)); ?>

                </span>
            </div>
            <p class="text-gray-300">Booking Reference: <span class="font-mono text-blue-400"><?php echo e($booking->booking_reference); ?></span></p>
        </div>
                ...
                <div class="bg-gray-800 rounded-lg p-6">
                    ...
                    <div class="space-y-3">
                        <div class="flex justify-between">
                            ...
                            <span class="text-white font-semibold"><?php echo e($booking->cottage->name); ?></span>
                        </div>
                        <div class="flex justify-between">
                            <span class="text-gray-400">Location:</span>
                            <span class="text-white"><?php echo e($booking->cottage->location ?? 'N/A'); ?></span>
                        </div>
                        <div class="flex justify-between">
                            <span class="text-gray-400">Capacity:</span>
                            <span class="text-white"><?php echo e($booking->cottage->capacity); ?> persons</span>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-gray-800 rounded-lg p-6">
                    ...
                    <div class="space-y-3">
                        <div class="flex justify-between">
                            ...
                            <span class="text-white font-semibold"><?php echo e(ucfirst(str_replace('_', ' ', $booking->booking_type))); ?></span>
                        </div>
                        <div class="flex justify-between">
                            <span class="text-gray-400">Check-in:</span>
                            <span class="text-white"><?php echo e($booking->check_in_date->format('M d, Y h:i A')); ?></span>
                        </div>
                        <?php if($booking->booking_type === 'overnight'): ?>
                        <div class="flex justify-between">
                            <span class="text-gray-400">Check-out:</span>
                            <span class="text-white"><?php echo e($booking->check_out_date->format('M d, Y h:i A')); ?></span>
                        </div>
                        <div class="flex justify-between">
                            <span class="text-gray-400">Duration:</span>
                            <span class="text-white"><?php echo e($booking->check_in_date->diffInDays($booking->check_out_date)); ?> night(s)</span>
                        </div>
                        <?php endif; ?>
                        <?php if($booking->booking_type === 'hourly' && $booking->hours_booked): ?>
                        <div class="flex justify-between">
                            <span class="text-gray-400">Hours Booked:</span>
                            <span class="text-white"><?php echo e($booking->hours_booked); ?> hours</span>
                        </div>
                        <?php endif; ?>
                        <div class="flex justify-between">
                            <span class="text-gray-400">Guests:</span>
                            <span class="text-white"><?php echo e($booking->guests); ?> adults<?php echo e($booking->children ? ', ' . $booking->children . ' children' : ''); ?></span>
                        </div>
                ...
                <div class="bg-gray-800 rounded-lg p-6">
                    ...
                    <div class="space-y-3">
                        <div class="flex justify-between">
                            ...
                            <span class="text-white font-bold text-xl"><?php echo e($booking->formatted_total_price); ?></span>
                        </div>
                        <div class="flex justify-between">
                            <span class="text-gray-400">Amount Paid:</span>
                            <span class="text-green-400 font-semibold"><?php echo e($booking->formatted_amount_paid); ?></span>
                        </div>
                        <div class="flex justify-between">
                            <span class="text-gray-400">Remaining Balance:</span>
                            <span class="text-yellow-400 font-semibold"><?php echo e($booking->formatted_remaining_balance); ?></span>
                        </div>
            ...
            <div class="lg:col-span-1">
                <div class="bg-gray-800 rounded-lg p-6 sticky top-4 space-y-4">
                    ...
                    <?php if($booking->canBeCancelled()): ?>
                        <form action="<?php echo e(route('guest.cottage-bookings.cancel', $booking)); ?>" method="POST" 
                    ...
                    <a href="<?php echo e(route('guest.cottage-bookings.index')); ?>" 
...
<?php echo $__env->make('layouts.guest', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\sethy\ValesBeach\resources\views\guest\cottage-bookings\show.blade.php ENDPATH**/ ?>