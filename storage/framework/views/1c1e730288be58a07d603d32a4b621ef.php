                    ...
                    <table class="w-full" id="staffTable">
                        <thead class="bg-gray-750">
                            <tr>
                                ...
                                <th class="px-6 py-4 text-center text-xs font-medium text-gray-400 uppercase tracking-wider">Service Requests</th>
                                <th class="px-6 py-4 text-center text-xs font-medium text-gray-400 uppercase tracking-wider">Housekeeping</th>
                        ...
                        <tbody class="divide-y divide-gray-700">
                            <?php $__empty_1 = true; $__currentLoopData = $staffMetrics; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $staff): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr class="hover:bg-gray-750 transition-colors">
                                ...
                                <td class="px-6 py-4 text-center">
                                    <div class="flex flex-col gap-1">
                                        <span class="inline-flex items-center justify-center px-2 py-1 rounded text-xs font-medium bg-purple-600/20 text-purple-400">
                                            <?php echo e(number_format($staff->service_requests_assigned)); ?> assigned
                                        </span>
                                        <span class="inline-flex items-center justify-center px-2 py-1 rounded text-xs font-medium bg-purple-600/10 text-purple-300">
                                            <?php echo e(number_format($staff->service_requests_completed)); ?> done
                                        </span>
                                    </div>
                                </td>
                                <td class="px-6 py-4 text-center">
                                    <div class="flex flex-col gap-1">
                                        <span class="inline-flex items-center justify-center px-2 py-1 rounded text-xs font-medium bg-cyan-600/20 text-cyan-400">
                                            <?php echo e(number_format($staff->housekeeping_assigned)); ?> assigned
                                        </span>
                                        <span class="inline-flex items-center justify-center px-2 py-1 rounded text-xs font-medium bg-cyan-600/10 text-cyan-300">
                                            <?php echo e(number_format($staff->housekeeping_completed)); ?> done
                                        </span>
                                    </div>
                                </td>
                                <td class="px-6 py-4 text-center">
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\VALESBEACH_LATEST\ValesBeach\resources\views/manager/reports/staff-performance.blade.php ENDPATH**/ ?>