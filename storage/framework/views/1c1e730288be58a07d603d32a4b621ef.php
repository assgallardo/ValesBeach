                ...
                <div class="p-6">
                    <?php if($staffMetrics->count() > 0): ?>
                        ...
                        <div class="mb-6">
                            ...
                            <p class="text-gray-300 mb-1"><?php echo e($topPerformer->name); ?></p>
                            <small class="text-gray-400"><?php echo e($topPerformer->completion_rate); ?>% completion rate</small>
                        </div>
                        ...
                        <div class="mb-6">
                            ...
                            <p class="text-gray-300 mb-1"><?php echo e($mostProductive->name); ?></p>
                            <small class="text-gray-400"><?php echo e($mostProductive->total_assigned); ?> tasks assigned</small>
                        </div>
                        ...
                        <div class="mb-6">
                            ...
                            <p class="text-gray-300 mb-1"><?php echo e($fastest->name); ?></p>
                            <small class="text-gray-400"><?php echo e($fastest->avg_completion_time); ?>h average</small>
                        </div>
                        <?php endif; ?>
                    <?php else: ?>
