...
<div class="container mx-auto px-4 lg:px-8 py-8">
    ...
    <div class="bg-gray-800 rounded-lg p-8">
        ...
        <form action="<?php echo e(route('manager.bookings.store')); ?>" method="POST" class="space-y-6">
            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.manager', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\VALESBEACH_LATEST\ValesBeach\resources\views/manager/bookings/create-from-room.blade.php ENDPATH**/ ?>