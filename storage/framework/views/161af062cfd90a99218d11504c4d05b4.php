...
<div class="container mx-auto px-4 lg:px-16 py-8">
    <div class="max-w-3xl mx-auto">
        ...
        <!-- Form -->
        <form action="<?php echo e(route('manager.rooms.update', $room)); ?>" method="POST" class="bg-gray-800 rounded-lg shadow-xl p-6" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
                    ...
                    <div>
                        ...
                        <div class="flex gap-2">
                            <input type="time"
                                   name="check_in_time"
                                   id="check_in_time"
                                   value="<?php echo e(old('check_in_time', $room->formatted_check_in_time ?? '')); ?>"
                    ...
                    <div>
                        ...
                        <div class="flex gap-2">
                            <input type="time"
                                   name="check_out_time"
                                   id="check_out_time"
                                   value="<?php echo e(old('check_out_time', $room->formatted_check_out_time ?? '')); ?>"
                                   class="flex-1 bg-gray-700 text-white rounded-lg px-4 py-2 focus:outline-none focus:ring-2 focus:ring-green-500">
                            <button type="button" 
...
<?php echo $__env->make('layouts.manager', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\VALESBEACH_LATEST\ValesBeach\resources\views/manager/rooms/edit.blade.php ENDPATH**/ ?>