...
<div class="min-h-screen bg-gray-900 py-6">
    <div class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="text-center mb-8">
            ...
            <h1 class="text-3xl font-bold text-green-50 mb-2">Payment <?php echo e($payment->status === 'completed' ? 'Completed' : 'Submitted'); ?>!</h1>
            <p class="text-gray-400"><?php echo e($payment->status === 'completed' ? 'Your payment has been processed successfully.' : 'Your payment is being processed.'); ?></p>
        </div>
        ...
        <div class="bg-gray-800 rounded-lg p-6 mb-6">
            ...
            <div class="space-y-4">
                ...
                <div class="flex justify-between items-center">
                    ...
                    <span class="text-green-400 font-bold text-lg"><?php echo e($payment->formatted_amount); ?></span>
                </div>
        ...
        <div class="bg-gray-800 rounded-lg p-6 mb-6">
            ...
            <div class="space-y-4">
                ...
                <div class="flex justify-between items-center">
                    ...
                    <span class="text-green-50 font-semibold"><?php echo e($payment->booking->formatted_total_price); ?></span>
                </div>
                
                <div class="flex justify-between items-center">
                    <span class="text-gray-400">Total Paid:</span>
                    <span class="text-green-50"><?php echo e($payment->booking->formatted_total_paid); ?></span>
                </div>
                
                <div class="flex justify-between items-center">
                    <span class="text-green-400 font-medium">Remaining Balance:</span>
                    <span class="text-green-400 font-bold"><?php echo e($payment->booking->formatted_remaining_balance); ?></span>
                </div>
            </div>
        </div>
...
<?php echo $__env->make('layouts.guest', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\VALESBEACH_LATEST\ValesBeach\resources\views/payments/confirmation.blade.php ENDPATH**/ ?>