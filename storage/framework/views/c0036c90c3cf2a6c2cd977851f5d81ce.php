        ...
        <div class="bg-gray-800 rounded-lg p-6 mb-6">
            ...
            <div class="space-y-4">
                ...
                <div class="flex justify-between items-center">
                    ...
                    <span class="text-green-400 font-bold text-lg">₱<?php echo e(number_format($payment->amount, 2)); ?></span>
                </div>
                <div class="flex justify-between items-center">
                ...
                <div class="flex justify-between items-center">
                    ...
                    <span class="inline-block px-3 py-1 rounded-full text-sm font-medium
                        <?php echo e($payment->status === 'completed' ? 'bg-green-500 text-white' : ($payment->status === 'pending' ? 'bg-yellow-500 text-black' : 'bg-gray-500 text-white')); ?>">
        ...
        <div class="bg-gray-800 rounded-lg p-6 mb-6">
            ...
            <div class="space-y-4">
                ...
                <div class="flex justify-between items-center border-t border-green-700/30 pt-3">
                    ...
                    <span class="text-green-50 font-bold">₱<?php echo e(number_format($payment->booking->total_price, 2)); ?></span>
                </div>
                <div class="flex justify-between items-center">
                    <span class="text-green-300">Total Amount Paid:</span>
                    <span class="text-green-400 font-bold">₱<?php echo e(number_format($payment->booking->amount_paid, 2)); ?></span>
                </div>
                <div class="flex justify-between items-center border-t border-green-700/30 pt-3">
                    <span class="text-green-100 font-semibold text-lg">Remaining Balance:</span>
                    <span class="font-bold text-2xl <?php echo e($payment->booking->remaining_balance > 0 ? 'text-yellow-400' : 'text-green-400'); ?>">
