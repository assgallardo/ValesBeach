            ...
            <div class="space-y-4">
                ...
                <div class="flex justify-between items-center">
                    ...
                    <span class="inline-flex items-center px-4 py-2 rounded-lg text-sm font-semibold
                        ...
                        <i class="fas fa-<?php echo e($payment->status === 'completed' ? 'check-circle' : ($payment->status === 'pending' ? 'clock' : 'info-circle')); ?> mr-1"></i>
                        ...
                        <div class="flex justify-between items-center bg-blue-900/20 rounded p-3 border border-blue-600/30">
                            <div>
                                ...
                                <p class="text-blue-200 text-xs">
                                    <?php if($previousPaid > 0): ?>
                                        ₱<?php echo e(number_format($previousPaid, 2)); ?> + ₱<?php echo e(number_format($payment->amount, 2)); ?>
