        ...
        <div class="bg-green-900/50 backdrop-blur-sm rounded-lg border border-green-700/30 p-8">
            ...
            <form action="<?php echo e(route('payments.store', $booking)); ?>" method="POST" id="paymentForm" class="space-y-6">
                ...
                <div>
                    ...
                    <input type="number" id="payment_amount" name="payment_amount" min="<?php echo e($minimumPayment); ?>" max="<?php echo e($remainingBalance); ?>" step="0.01" value="<?php echo e(old('payment_amount', $remainingBalance)); ?>" required class="w-full px-4 py-3 bg-green-800/50 border border-green-600/50 rounded-lg text-green-100 text-xl font-bold focus:ring-2 focus:ring-green-500 focus:border-transparent" oninput="updatePaymentSummary()">
                    <p class="text-green-400 text-sm mt-2">Minimum payment: ₱<?php echo e(number_format($minimumPayment, 2)); ?></p>
                </div>
                <!-- Payment Method -->
                <div>
                ...
                <div class="bg-green-800/30 rounded-lg p-6 mb-6" id="paymentSummary">
                    ...
                    <div class="space-y-2">
                        <div class="flex justify-between">
                            ...
                            <span class="text-green-50 font-bold" id="summaryAmount">₱<?php echo e(number_format($remainingBalance, 2)); ?></span>
                        </div>
                        <div class="flex justify-between">
                            <span class="text-green-300">Current Paid:</span>
                            <span class="text-green-50">₱<?php echo e(number_format($booking->amount_paid, 2)); ?></span>
                        </div>
...
function updatePaymentSummary() {
    ...
    const currentPaid = <?php echo e($booking->amount_paid); ?>;
