                ...
                <div class="border-t border-gray-700 pt-4 mt-4">
                    ...
                    <div class="bg-green-800 bg-opacity-30 border border-green-700 rounded-lg p-3 mb-2">
                        <div class="flex items-center">
                            ...
                            <span class="text-green-400 font-semibold">+₱<?php echo e(number_format($booking->early_checkin_fee, 2)); ?></span>
                        </div>
                    </div>
                    <?php endif; ?>
                    ...
                    <div class="bg-yellow-800 bg-opacity-30 border border-yellow-700 rounded-lg p-3">
                        <div class="flex items-center">
                            ...
                            <span class="text-yellow-400 font-semibold">+₱<?php echo e(number_format($booking->late_checkout_fee, 2)); ?></span>
                        </div>
                    </div>
                    <?php endif; ?>
                </div>
            ...
            <div class="space-y-4">
                ...
                <div class="border-t border-gray-700 pt-3">
                    ...
                    <div class="flex justify-between text-sm mb-1">
                        ...
                        <span class="text-white">₱<?php echo e(number_format($booking->early_checkin_fee, 2)); ?></span>
                    </div>
                    <?php endif; ?>
                    ...
                    <div class="flex justify-between text-sm">
                        ...
                        <span class="text-white">₱<?php echo e(number_format($booking->late_checkout_fee, 2)); ?></span>
                    </div>
                    <?php endif; ?>
                </div>
                ...
                <div class="border-t border-gray-700 pt-3">
                    <div class="flex justify-between items-center">
                        ...
                        <p class="text-green-400 text-2xl font-bold"><?php echo e($booking->formatted_grand_total); ?></p>
                    </div>
                </div>
                <?php else: ?>
                <div>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\sethy\ValesBeach\resources\views\admin\bookings\show.blade.php ENDPATH**/ ?>