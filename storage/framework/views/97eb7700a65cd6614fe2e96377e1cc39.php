...
function editBookingDetails(booking) {
    ...
    form.action = `<?php echo e(url('admin/bookings')); ?>/${booking.id}`;
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\VALESBEACH_LATEST\ValesBeach\resources\views/admin/reservations/index.blade.php ENDPATH**/ ?>