        ...
        <div class="bg-gray-800 rounded-lg p-6 mb-6">
            ...
            <div class="space-y-4">
                ...
                <div class="flex justify-between items-center bg-green-900/20 rounded-lg p-3 border border-green-600/30">
                    ...
                    <span class="text-green-400 font-bold text-2xl">₱{{ number_format($payment->amount, 2) }}</span>
                </div>
                <div class="bg-gray-700/50 rounded-lg p-4 border-2 border-gray-600">
                    ...
                    <div class="flex items-center">
                        ...
                        @endphp
                        <i class="fas fa-{{ $icon }} text-3xl {{ $iconColor }} mr-3"></i>
                        <span class="text-green-50 font-bold text-xl">{{ $payment->payment_method_display }}</span>
                    </div>
                </div>
                <div class="flex justify-between items-center">
                    <span class="text-gray-400">
        ...
        <div class="bg-gray-800 rounded-lg p-6 mb-6">
            ...
            <div class="space-y-4">
                ...
                <div class="border-t border-green-700/30 pt-4 mt-4">
                    ...
                    <div class="bg-gray-900/50 rounded-lg p-4 space-y-3">
                        ...
                        <div class="flex justify-between items-center pb-2">
                            ...
                            <span class="text-green-50 font-bold text-lg">₱{{ number_format($payment->booking->total_price, 2) }}</span>
                        </div>
                        ...
                        <div class="flex justify-between items-center pb-2">
                            ...
                            <span class="text-gray-300 font-medium">₱{{ number_format($previousPaid, 2) }}</span>
                        </div>
                        @endif
                ...
                <div class="border-t border-green-700/30 pt-4 mt-3">
                    ...
                    <div class="bg-gray-800/50 rounded-lg p-4 mb-3">
                        <div class="text-center space-y-2">
                            ...
                            <div class="flex items-center justify-center gap-3 text-lg font-mono">
                                <span class="text-green-50">₱{{ number_format($payment->booking->total_price, 2) }}</span>
                                <span class="text-gray-500">−</span>
                                <span class="text-blue-400">₱{{ number_format($payment->booking->amount_paid, 2) }}</span>
                                <span class="text-gray-500">=</span>
                                <span class="font-bold {{ $payment->booking->remaining_balance > 0 ? 'text-yellow-400' : 'text-green-400' }}">
                    ...
                    <div class="flex justify-between items-center pb-3 bg-{{ $payment->booking->remaining_balance > 0 ? 'yellow' : 'green' }}-900/20 rounded-lg p-4 border-2 border-{{ $payment->booking->remaining_balance > 0 ? 'yellow' : 'green' }}-600/50">
                        <div>
                            <span class="text-{{ $payment->booking->remaining_balance > 0 ? 'yellow' : 'green' }}-200 font-semibold text-lg">
                                <i class="fas fa-{{ $payment->booking->remaining_balance > 0 ? 'exclamation-triangle' : 'check-circle' }} mr-2"></i>Remaining Balance:
                            </span>
                            <p class="text-gray-400 text-xs mt-1">
                                {{ $payment->booking->remaining_balance > 0 ? 'Amount still due' : 'Fully paid' }}
                            </p>
                        </div>
                        <span class="font-bold text-4xl {{ $payment->booking->remaining_balance > 0 ? 'text-yellow-400' : 'text-green-400' }}">
                            ₱{{ number_format($payment->booking->remaining_balance, 2) }}
                        </span>
                    </div>
                            ...
                            <div class="flex items-start">
                                ...
                                <div class="flex-1">
                                    ...
                                    <p class="text-yellow-300 text-sm mt-1">
                                        ...
                                        <span class="font-bold text-yellow-100">₱{{ number_format($payment->booking->remaining_balance, 2) }}</span>
            ...
            <div class="flex items-start">
                ...
                <div class="flex-1">
                    ...
                    <p class="text-blue-300 text-sm mt-1">
                        ...
                        @elseif($payment->booking->remaining_balance > 0)
        ...
        <div class="bg-gradient-to-r from-yellow-900/30 to-orange-900/30 border-2 border-yellow-600/50 rounded-lg p-6 mb-6">
            <div class="text-center mb-4">
                ...
                <p class="text-yellow-300 text-sm">
                    You still have a remaining balance of <span class="font-bold text-yellow-100 text-lg">₱{{ number_format($payment->booking->remaining_balance, 2) }}</span>
                </p>
            </div>
