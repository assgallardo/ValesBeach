...
<div class="min-h-screen bg-gray-900 py-6">
    ...
    <div class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
        <!-- Back Button -->
        <div class="mb-6">
            <a href="{{ route('payments.confirmation', $payment) }}" class="text-green-400 hover:text-green-300 transition-colors">
        ...
        <div class="bg-gray-800 rounded-lg p-6 mb-6">
            ...
            <div class="space-y-3">
                ...
                <div class="flex justify-between items-center">
                    ...
                    <span class="text-green-400 font-medium">₱{{ number_format($booking->amount_paid - $payment->amount, 2) }}</span>
                </div>
        ...
        <div class="bg-gray-800 rounded-lg p-6 mb-6">
            ...
            <form action="{{ route('payments.update', $payment) }}" method="POST" id="paymentForm" class="space-y-6">
                @csrf
                @method('PATCH')
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="number" 
                               ...
                               step="0.01" 
                               value="{{ old('payment_amount', $payment->amount) }}" 
                               required 
                    ...
                    <div class="flex justify-between items-center mt-2 text-sm">
                        <p class="text-green-400">
                            ...
                            Minimum: ₱{{ number_format($minimumPayment, 2) }}
                        </p>
                        <p class="text-green-400">
                    ...
                    <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                        ...
                        <label class="payment-method-option cursor-pointer">
                            <input type="radio" name="payment_method" value="card" class="sr-only payment-method-radio"
                                   {{ old('payment_method', $payment->payment_method) === 'card' ? 'checked' : '' }}
                        ...
                        <label class="payment-method-option cursor-pointer">
                            <input type="radio" name="payment_method" value="gcash" class="sr-only payment-method-radio"
                                   {{ old('payment_method', $payment->payment_method) === 'gcash' ? 'checked' : '' }}
                        ...
                        <label class="payment-method-option cursor-pointer">
                            <input type="radio" name="payment_method" value="bank_transfer" class="sr-only payment-method-radio"
                                   {{ old('payment_method', $payment->payment_method) === 'bank_transfer' ? 'checked' : '' }}
                ...
                <div>
                    ...
                    <textarea name="notes" rows="3" placeholder="Add any payment notes..." class="w-full px-4 py-3 bg-green-800/50 border border-green-600/50 rounded-lg text-green-100 placeholder-green-400 focus:ring-2 focus:ring-green-500 focus:border-transparent">{{ old('notes', $payment->notes) }}</textarea>
                </div>
                ...
                <div class="flex flex-col sm:flex-row gap-4">
                    ...
                    <a href="{{ route('payments.confirmation', $payment) }}" class="flex-1 bg-gray-600 text-white px-6 py-3 rounded-lg text-center hover:bg-gray-700 focus:ring-2 focus:ring-gray-500 transition-colors">
