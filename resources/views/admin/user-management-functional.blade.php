        ...
        <div class="container mx-auto px-4 lg:px-16">
            <div class="flex items-center justify-between h-32">
                ...
                <div class="flex items-center space-x-6 lg:space-x-8">
                    <a href="{{ route('admin.dashboard') }}" class="text-green-50 text-lg lg:text-xl font-light hover:text-green-200 transition-colors duration-200">
                        Dashboard
                    </a>
        ...
        <div class="container mx-auto px-4 lg:px-16">
            ...
            <div class="bg-gray-800 rounded-lg p-4 lg:p-6 mb-8 shadow-lg">
                <div class="flex flex-col md:flex-row justify-between items-center gap-4">
                    ...
                    <!-- Filter Dropdown -->
                    <div class="relative">
                        <select id="roleFilter" class="px-4 py-3 bg-gray-700 border border-gray-600 rounded-lg text-white focus:outline-none focus:ring-2 focus:ring-blue-500">
                    ...
                    <!-- Add User Button -->
                    <button id="addUserBtn" class="px-6 py-3 bg-blue-600 text-white font-medium rounded-lg hover:bg-blue-700 transition-colors duration-200 flex items-center gap-2">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <span class="px-2 py-1 text-xs font-medium rounded-full
                                        {{ $user->role === 'admin' ? 'bg-red-600 text-white' :
                                           ...
                                           ($user->role === 'staff' ? 'bg-purple-600 text-white' : 'bg-gray-600 text-white')) }}">
