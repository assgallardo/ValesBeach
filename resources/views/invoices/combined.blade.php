            ...
            <div class="bg-gradient-to-r from-green-600 to-green-700 p-8 text-white">
                <div class="flex items-center justify-between mb-6">
                    ...
                    <div class="text-right">
                        ...
                        <p class="text-green-100 text-sm">{{ \Carbon\Carbon::parse($invoice->created_at)->format('M d, Y') }}</p>
                    </div>
                </div>
                ...
                <div class="grid md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <p class="text-green-100">{{ auth()->user()->name }}</p>
                ...
                <div class="flex justify-end">
                    <div class="w-full md:w-1/2">
                        <div class="bg-gray-50 rounded-lg p-6">
                            ...
                            <div class="flex justify-between py-2 border-t border-gray-200 font-bold text-lg {{ $invoice->total_balance > 0 ? 'text-red-600' : 'text-green-600' }}">
                ...
                <div class="mt-8 bg-yellow-50 border-l-4 border-yellow-500 p-4 rounded">
                    <div class="flex items-center">
                        ...
                        <div>
                            ...
                            <p class="text-sm text-yellow-700">Outstanding balance: ₱{{ number_format($invoice->total_balance, 2) }}</p>
                        </div>
                    </div>
                </div>
                @endif
