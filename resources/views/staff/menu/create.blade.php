...
<div class="container-fluid py-4">
    <div class="row mb-4">
        <div class="col-12">
            <div class="d-flex justify-content-between align-items-center">
                <h2 class="mb-0">Add New Menu Item</h2>
    ...
    <div class="card">
        <div class="card-body">
            <form action="{{ route('staff.menu.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                    ...
                    <div class="col-md-8">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="ingredients" name="ingredients" 
                                   value="{{ old('ingredients') }}" placeholder="e.g., Chicken, Rice, Vegetables">
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="allergens" name="allergens" 
                                   value="{{ old('allergens') }}" placeholder="e.g., Peanuts, Dairy, Gluten">
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" id="is_dairy_free" 
                                       name="is_dairy_free" value="1" {{ old('is_dairy_free') ? 'checked' : '' }}>
