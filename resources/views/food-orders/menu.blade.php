                ...
                @endif
                            ...
                            <div class="p-5 bg-gray-800/90 backdrop-blur-sm">
                                <div class="flex justify-between items-start mb-3">
                                    ...
                                    <span class="text-2xl font-bold text-yellow-400 ml-2">₱{{ number_format($item->price, 2) }}</span>
                    </div>
        ...
        <div id="menu-data" class="hidden">
            ...
            @foreach($category->menuItems as $item)
                <div class="menu-item-data" data-item-id="{{ $item->id }}">
                    ...
                    <input type="hidden" name="item_ingredients" value="{{ $item->ingredients ? implode(', ', $item->ingredients) : '' }}">
                    <input type="hidden" name="item_allergens" value="{{ $item->allergens ? implode(', ', $item->allergens) : '' }}">
