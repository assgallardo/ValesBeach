            ...
            <div class="lg:col-span-2">
                <div class="bg-gray-800 rounded-xl shadow-2xl overflow-hidden">
                    ...
                    <div class="divide-y divide-gray-700">
                        ...
                        <div class="p-6 cart-item hover:bg-gray-700/50 transition-colors duration-200 relative" data-cart-key="{{ $cartKey }}">
                            <!-- Remove Button (X) -->
                            ...
                            <div class="flex items-start space-x-4">
                                ...
                                <div class="flex-1 min-w-0">
                                    <h3 class="font-bold text-xl text-white mb-1">{{ $item['menu_item']->name }}</h3>
                                    
                                    @if($item['menu_item']->description)
                                    <p class="text-gray-400 text-sm mt-1 mb-2">{{ $item['menu_item']->description }}</p>
                                    @endif
                ...
                <div class="bg-gray-800 rounded-xl shadow-2xl p-6 sticky top-4 border border-gray-700">
                    ...
                    <div class="space-y-4 mb-6">
                        <div class="flex justify-between items-center p-3 bg-gray-700/50 rounded-lg">
                            ...
                            <span class="font-bold text-white text-lg" id="subtotal">₱{{ number_format($subtotal, 2) }}</span>
                        </div>
                    ...
                    <div class="border-t border-gray-700 pt-4 mb-6">
                        <div class="flex justify-between items-center p-4 bg-gradient-to-r from-green-900/50 to-green-800/50 rounded-lg">
                            ...
                            <span class="text-2xl font-bold text-green-400" id="total">₱{{ number_format($subtotal, 2) }}</span>
                        </div>
                    </div>
