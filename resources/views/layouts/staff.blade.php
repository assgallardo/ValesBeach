        ...
        <nav class="mt-6">
            <div class="px-4 space-y-2">
                ...
                <a href="{{ route('staff.rooms.index') }}"
                   class="flex items-center px-4 py-2 rounded-lg {{ request()->routeIs('staff.rooms.*') ? 'bg-green-600' : 'hover:bg-green-800/50' }} text-white">
                    <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <a href="{{ route('staff.bookings.index') }}"
                   class="flex items-center px-4 py-2 rounded-lg {{ request()->routeIs('staff.bookings.*') ? 'bg-green-600' : 'hover:bg-green-800/50' }} text-white">
                    <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <a href="{{ route('staff.menu.index') }}"
                   class="flex items-center px-4 py-2 rounded-lg {{ request()->routeIs('staff.menu.*') ? 'bg-green-600' : 'hover:bg-green-800/50' }} text-white">
                    <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
