            ...
            <div class="flex justify-between items-center h-16">
                ...
                <div class="flex">
                    <a href="{{ 
                        ...
                        (auth()->user()->role === 'manager' ? route('manager.dashboard') : route('staff.dashboard')) 
            ...
            <nav class="mt-6">
                <div class="px-4 space-y-2">
                    <a href="{{ route('staff.dashboard') }}"
                       class="flex items-center px-4 py-2 rounded-lg {{ request()->routeIs('staff.dashboard') ? 'bg-green-600' : 'hover:bg-gray-700' }} text-white transition-colors">
                    ...
                    <a href="{{ route('admin.rooms.index') }}"
                       class="flex items-center px-4 py-2 rounded-lg {{ request()->routeIs('admin.rooms.*') ? 'bg-green-600' : 'hover:bg-gray-700' }} text-white transition-colors">
                        <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <a href="{{ route('admin.reservations') }}"
                       class="flex items-center px-4 py-2 rounded-lg {{ request()->routeIs('admin.reservations') ? 'bg-green-600' : 'hover:bg-gray-700' }} text-white transition-colors">
                        <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <a href="{{ route('admin.calendar') }}"
                       class="flex items-center px-4 py-2 rounded-lg {{ request()->routeIs('admin.calendar') ? 'bg-green-600' : 'hover:bg-gray-700' }} text-white transition-colors">
                        <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"/>
                        </svg>
                        Calendar
                    ...
                    <a href="{{ route('staff.menu.index') }}"
                       class="flex items-center px-4 py-2 rounded-lg {{ request()->routeIs('staff.menu.*') ? 'bg-green-600' : 'hover:bg-gray-700' }} text-white transition-colors">
                        <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <a href="{{ route('staff.orders.index') }}"
                       class="flex items-center px-4 py-2 rounded-lg {{ request()->routeIs('staff.orders.*') ? 'bg-green-600' : 'hover:bg-gray-700' }} text-white transition-colors">
                        <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
