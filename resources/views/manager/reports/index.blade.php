                ...
                <div class="flex flex-col sm:flex-row space-y-2 sm:space-y-0 sm:space-x-3">
                    ...
                    <div class="relative">
                        ...
                        <div id="exportDropdown" class="absolute right-0 mt-2 w-72 bg-gray-800 border border-gray-700 rounded-lg shadow-xl z-10 hidden max-h-96 overflow-y-auto">
                            ...
                            <div class="py-1">
                                <a href="{{ route('manager.reports.export', ['type' => 'room-sales'] + request()->query()) }}" 
                                   class="flex items-center px-4 py-2.5 text-gray-300 hover:bg-gray-700 hover:text-green-400 transition-colors">
                                ...
                                <a href="{{ route('manager.reports.export', ['type' => 'food-sales'] + request()->query()) }}" 
                                   class="flex items-center px-4 py-2.5 text-gray-300 hover:bg-gray-700 hover:text-green-400 transition-colors">
                                ...
                                <a href="{{ route('manager.reports.export', ['type' => 'service-sales'] + request()->query()) }}" 
                                   class="flex items-center px-4 py-2.5 text-gray-300 hover:bg-gray-700 hover:text-green-400 transition-colors">
                            ...
                            <div class="py-1">
                                <a href="{{ route('manager.reports.export', ['type' => 'repeat-customers'] + request()->query()) }}" 
                                   class="flex items-center px-4 py-2.5 text-gray-300 hover:bg-gray-700 hover:text-green-400 transition-colors">
                                ...
                                <a href="{{ route('manager.reports.export', ['type' => 'payment-methods'] + request()->query()) }}" 
                                   class="flex items-center px-4 py-2.5 text-gray-300 hover:bg-gray-700 hover:text-green-400 transition-colors">
                ...
                <div class="p-6">
                    ...
                    <div class="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
                        <div class="bg-gray-900 rounded-lg p-4 border border-gray-700">
                            ...
                            <h4 class="text-2xl font-bold text-green-50">{{ number_format($foodSalesOverview['total_orders']) }}</h4>
                        ...
                        <div class="bg-gray-900 rounded-lg p-4 border border-gray-700">
                            ...
                            <h4 class="text-2xl font-bold text-green-50">{{ number_format($foodSalesOverview['completed_orders']) }}</h4>
                            <p class="text-gray-400 text-xs uppercase tracking-wider mt-1">Completed</p>
                        </div>
                        ...
                        <div class="bg-gray-900 rounded-lg p-4 border border-gray-700">
                            ...
                            <h4 class="text-2xl font-bold text-green-50">₱{{ number_format($foodSalesOverview['total_revenue'], 0) }}</h4>
                            <p class="text-gray-400 text-xs uppercase tracking-wider mt-1">Total Revenue</p>
                        </div>
                        ...
                        <div class="bg-gray-900 rounded-lg p-4 border border-gray-700">
                            ...
                            <h4 class="text-2xl font-bold text-green-50">₱{{ number_format($foodSalesOverview['avg_order_value'] ?? 0, 0) }}</h4>
                            <p class="text-gray-400 text-xs uppercase tracking-wider mt-1">Avg. Order</p>
                        </div>
                    </div>

                    <!-- Top Menu Items -->
                    @if($topMenuItems && $topMenuItems->count() > 0)
                    <div class="bg-gray-900 rounded-lg border border-gray-700 overflow-hidden">
                                ...
                                <div class="flex items-center justify-between">
                                    <div class="flex items-center flex-1">
                                        ...
                                        <div class="flex-1 min-w-0">
                                            <p class="text-gray-200 text-sm font-medium truncate">{{ $item->name }}</p>
                                            <p class="text-xs text-gray-400">{{ number_format($item->total_quantity) }} sold</p>
                                        </div>
                                    </div>
                                    <div class="text-right ml-4">
                                        <p class="text-green-400 font-semibold text-sm">₱{{ number_format($item->total_revenue, 0) }}</p>
                                    </div>
                                </div>
                                @endforeach
                            </div>
