        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
            <div class="bg-gray-800 rounded-lg border border-gray-700 overflow-hidden">
                <div class="p-6 text-center">
                    ...
                    <h3 class="text-3xl font-bold text-green-50 mb-2">{{ $staffMetrics->count() }}</h3>
            ...
            <div class="bg-gray-800 rounded-lg border border-gray-700 overflow-hidden">
                <div class="p-6 text-center">
                    ...
                    <h3 class="text-3xl font-bold text-green-50 mb-2">{{ number_format($staffMetrics->sum('total_assigned')) }}</h3>
            ...
            <div class="bg-gray-800 rounded-lg border border-gray-700 overflow-hidden">
                <div class="p-6 text-center">
                    ...
                    <h3 class="text-3xl font-bold text-green-50 mb-2">{{ number_format($staffMetrics->sum('completed_tasks')) }}</h3>
            ...
            <div class="bg-gray-800 rounded-lg border border-gray-700 overflow-hidden">
                <div class="p-6 text-center">
                    ...
                    @endphp
                    <h3 class="text-3xl font-bold text-green-50 mb-2">{{ round($avgCompletionRate, 1) }}%</h3>
                            ...
                            <tr class="hover:bg-gray-750 transition-colors">
                                ...
                                <td class="px-6 py-4 text-center">
                                    ...
                                    <div class="text-center">
                                        ...
                                        <small class="text-{{ $ratingClass }}-400">{{ $rating }}</small>
                                    </div>
                                </td>
                            </tr>
                            @empty
                    ...
                    <div class="bg-gray-750 rounded-lg p-4 border border-gray-600">
                        <div class="flex items-start">
                            ...
                            <div>
                                ...
                                @endif
                                <small class="text-gray-400">Range: {{ $minTasks }} - {{ $maxTasks }} tasks per staff member</small>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bg-gray-750 rounded-lg p-4 border border-gray-600">
                        <div class="flex items-start">
                            ...
                            <div>
                                ...
                                @elseif($needsTraining <= 2)
                                    <p class="text-yellow-400 text-sm">{{ $needsTraining }} staff member(s) may benefit from additional training and support.</p>
                                @else
                                    <p class="text-red-400 text-sm">{{ $needsTraining }} staff members need focused training and mentoring programs.</p>
                                @endif
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bg-gray-750 rounded-lg p-4 border border-gray-600">
                        <div class="flex items-start">
                            ...
                            <div>
                                ...
                                @if($highPerformers > 0)
                                    <p class="text-indigo-400 text-sm">{{ $highPerformers }} staff member(s) deserve recognition for outstanding performance.</p>
                                @else
