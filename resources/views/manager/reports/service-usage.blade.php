            ...
            <div class="grid grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-3">
                ...
                <div class="category-filter active cursor-pointer group bg-gradient-to-br from-gray-800 to-gray-900 rounded-lg p-4 border-2 border-green-500 hover:border-green-400 transition-all duration-300 hover:shadow-xl hover:scale-105 shadow-lg shadow-green-500/30" 
                    ...
                    <div class="text-center">
                        ...
                        @endphp
                        <h4 class="text-xl font-bold text-white mb-0.5">{{ number_format($totalRequests) }}</h4>
                ...
                <div class="category-filter cursor-pointer group bg-gradient-to-br from-gray-800 to-gray-900 rounded-lg p-4 border-2 border-gray-700 hover:border-gray-600 transition-all duration-300 hover:shadow-xl hover:scale-105" 
                    ...
                    <div class="text-center">
                        ...
                        @endswitch
                        <h4 class="text-xl font-bold text-white mb-0.5">{{ number_format($category->total_requests) }}</h4>
                        <p class="text-gray-400 text-[10px] uppercase tracking-wider font-semibold">{{ ucfirst(str_replace('_', ' ', $category->category)) }}</p>
                    </div>
                </div>
                @endforeach
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div class="relative bg-gradient-to-br from-green-900/50 to-green-800/30 rounded-lg p-4 border border-green-600/30 overflow-hidden group hover:border-green-500/50 transition-all duration-300">
                    ...
                    <div class="relative">
                        ...
                        <p class="text-white font-bold text-base mb-1">{{ $topService->name }}</p>
                        <div class="flex items-center">
                            <div class="flex-1">
                                <div class="bg-green-500/20 rounded-full h-1.5">
                                    <div class="bg-green-400 h-1.5 rounded-full" style="width: {{ $topService->completion_rate }}%"></div>
                                </div>
                            </div>
                            <span class="ml-2 text-green-400 font-bold text-sm">{{ $topService->completion_rate }}%</span>
                        </div>
                    </div>
                </div>
                ...
                <div class="relative bg-gradient-to-br from-blue-900/50 to-blue-800/30 rounded-lg p-4 border border-blue-600/30 overflow-hidden group hover:border-blue-500/50 transition-all duration-300">
                    ...
                    <div class="relative">
                        ...
                        <p class="text-white font-bold text-base mb-1">{{ $popularService->name }}</p>
                        <div class="flex items-center">
                            <i class="fas fa-clipboard-check text-blue-400 mr-1.5 text-sm"></i>
                            <span class="text-blue-300 font-semibold text-sm">{{ number_format($popularService->total_requests) }} requests</span>
                        </div>
                    </div>
                </div>
                ...
                <div class="relative bg-gradient-to-br from-yellow-900/50 to-yellow-800/30 rounded-lg p-4 border border-yellow-600/30 overflow-hidden group hover:border-yellow-500/50 transition-all duration-300">
                    ...
                    <div class="relative">
                        ...
                        <p class="text-white font-bold text-base mb-1">{{ $needsAttention->name }}</p>
                        <div class="flex items-center">
                            <div class="flex-1">
                                <div class="bg-yellow-500/20 rounded-full h-1.5">
                                    <div class="bg-yellow-400 h-1.5 rounded-full" style="width: {{ $needsAttention->completion_rate }}%"></div>
                                </div>
                            </div>
                            <span class="ml-2 text-yellow-400 font-bold text-sm">{{ $needsAttention->completion_rate }}%</span>
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            <td class="px-6 py-4">
                                <div class="flex items-center">
                                    <div class="w-10 h-10 rounded-lg flex items-center justify-center mr-3
                                        {{ $service->category == 'spa' ? 'bg-purple-500/20' : '' }}
                                        {{ $service->category == 'dining' ? 'bg-green-500/20' : '' }}
                                        {{ $service->category == 'activities' ? 'bg-yellow-500/20' : '' }}
                                        {{ $service->category == 'transportation' ? 'bg-blue-500/20' : '' }}
                                        {{ $service->category == 'room_service' ? 'bg-red-500/20' : '' }}">
                                    ...
                                    <div>
                                        <h6 class="text-white font-semibold group-hover:text-green-400 transition-colors">{{ $service->name }}</h6>
                                        @if($service->description)
                                            <small class="text-gray-500 text-xs">{{ Str::limit($service->description, 40) }}</small>
                                        @endif
                                    </div>
                                </div>
                            </td>
                            ...
                            <td class="px-6 py-4">
                                <div class="flex items-center justify-center space-x-3">
                                    <div class="w-24">
                                        <div class="bg-gray-700 rounded-full h-2 overflow-hidden">
                                            <div class="h-2 rounded-full transition-all duration-300
                                                {{ $service->completion_rate >= 80 ? 'bg-gradient-to-r from-green-400 to-green-500' : 
                                    ...
                                    <span class="text-sm font-bold
                                        {{ $service->completion_rate >= 80 ? 'text-green-400' : 
