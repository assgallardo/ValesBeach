            ...
            <div class="lg:col-span-2 space-y-6">
                ...
                <div class="bg-green-900/50 backdrop-blur-sm rounded-lg p-6 border border-green-700/30">
                    <div class="flex items-center justify-between mb-6">
                        ...
                        @endphp
                        <span class="px-4 py-2 rounded-full text-sm font-medium {{ $statusColors[$serviceRequest->status] ?? 'bg-gray-600 text-gray-100' }}">
                    ...
                    <div class="space-y-4">
                        <div class="flex items-start">
                            ...
                            <div class="ml-4 flex-1">
                                ...
                                <p class="text-green-200 text-sm">{{ $serviceRequest->requested_at ? $serviceRequest->requested_at->format('M d, Y H:i') : 'N/A' }}</p>
                            </div>
                        </div>
                        ...
                        <div class="flex items-start">
                            ...
                            <div class="ml-4 flex-1">
                                ...
                                <p class="text-green-200 text-sm">{{ $serviceRequest->assigned_at->format('M d, Y H:i') }}</p>
                            </div>
                        </div>
                        @endif
                        ...
                        <div class="flex items-start">
                            ...
                            <div class="ml-4 flex-1">
                                ...
                                <p class="text-green-200 text-sm">{{ $serviceRequest->scheduled_at->format('M d, Y H:i') }}</p>
                            </div>
                        </div>
                        @endif
                        ...
                        <div class="flex items-start">
                            ...
                            <div class="ml-4 flex-1">
                                ...
                                <p class="text-green-200 text-sm">{{ $serviceRequest->completed_at->format('M d, Y H:i') }}</p>
                            </div>
                        </div>
                        @endif
                    </div>
                    ...
                    <div class="space-y-4">
                        <div class="flex items-start">
                            ...
                            <div>
                                ...
                                <p class="text-green-50 font-medium text-lg">{{ $serviceRequest->service ? $serviceRequest->service->name : 'N/A' }}</p>
                            </div>
                        </div>
                        ...
                        <div class="flex items-start">
                            ...
                            <div>
                                ...
                                <p class="text-green-50 font-medium">{{ ucfirst($serviceRequest->service_type) }}</p>
                            </div>
                        </div>
                        @endif
                        ...
                        <div class="flex items-start">
                            ...
                            <div>
                                ...
                                <p class="text-green-50">{{ $serviceRequest->description }}</p>
                            </div>
                        </div>
                        @endif
                        ...
                        <div class="flex items-start">
                            ...
                            <div>
                                ...
                                <p class="text-green-50 font-medium">{{ $serviceRequest->guests_count }}</p>
                            </div>
                        </div>
                        @endif
                        ...
                        <div class="flex items-start">
                            ...
                            <div>
                                ...
                                <p class="text-green-50 font-medium">{{ \Carbon\Carbon::parse($serviceRequest->scheduled_date)->format('M d, Y') }}</p>
                            </div>
                        </div>
                        @endif
                    </div>
                ...
                <!-- Notes -->
                @if($serviceRequest->notes || $serviceRequest->manager_notes)
                <div class="bg-green-900/50 backdrop-blur-sm rounded-lg p-6 border border-green-700/30">
                    ...
                    <div class="mb-4 bg-green-800/30 rounded-lg p-4">
                        ...
                        <p class="text-green-50">{{ $serviceRequest->notes }}</p>
                    </div>
                    @endif
                    ...
                    <div class="bg-blue-900/30 rounded-lg p-4">
                        ...
                        <p class="text-blue-50">{{ $serviceRequest->manager_notes }}</p>
                    </div>
                    @endif
                </div>
                @endif
            ...
            <div class="space-y-6">
                ...
                <div class="bg-green-900/50 backdrop-blur-sm rounded-lg p-6 border border-green-700/30">
                    ...
                    <div class="space-y-3">
                        <div>
                            ...
                            <p class="text-green-50 font-medium">{{ $serviceRequest->guest_name }}</p>
                        </div>
                        
                        <div>
                            <p class="text-green-200 text-sm">Email</p>
                            <p class="text-green-50">{{ $serviceRequest->guest_email }}</p>
                        </div>
                        
                        <div>
                            <p class="text-green-200 text-sm">Room Number</p>
                            <p class="text-green-50 font-medium">{{ $serviceRequest->room_number }}</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-green-900/50 backdrop-blur-sm rounded-lg p-6 border border-green-700/30">
                    ...
                    <div class="flex items-center justify-center">
                        <span class="px-4 py-2 rounded-full text-lg font-medium {{ $priorityColors[$serviceRequest->priority] ?? 'bg-gray-600 text-gray-100' }}">
                ...
                <div class="bg-green-900/50 backdrop-blur-sm rounded-lg p-6 border border-green-700/30">
                    ...
                    <div class="flex items-center">
                        <div class="w-12 h-12 bg-green-600 rounded-full flex items-center justify-center text-white font-bold text-lg mr-3">
                            {{ substr($serviceRequest->assignedStaff->name, 0, 1) }}
                        </div>
                        <div>
                            <p class="text-green-50 font-medium">{{ $serviceRequest->assignedStaff->name }}</p>
                            <p class="text-green-200 text-sm">{{ $serviceRequest->assignedStaff->email }}</p>
                        </div>
                    </div>
                </div>
                @endif
...
<div id="quickUpdateModal" class="fixed inset-0 bg-black/70 hidden items-center justify-center z-50" style="display: none;">
    <div class="bg-green-900 rounded-lg p-8 max-w-md w-full mx-4 border border-green-700">
        ...
        <form id="quickUpdateForm" method="POST" action="{{ route('manager.service-requests.updateStatus', $serviceRequest) }}">
            @csrf
            @method('PATCH')
