...
<div class="container mx-auto px-4 lg:px-16 py-8">
    <div class="max-w-4xl mx-auto">
        <div class="bg-gray-800 rounded-lg p-6 mb-6">
            <h1 class="text-3xl font-bold text-white mb-2">Book {{ $cottage->name }}</h1>
        ...
        <form action="{{ route('guest.cottages.book.store', $cottage) }}" method="POST" id="bookingForm" class="space-y-6">
            @csrf
                ...
                <div class="lg:col-span-2 space-y-6">
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            ...
                            <label class="cursor-pointer">
                                ...
                                <div class="bg-gray-700 peer-checked:bg-blue-600 peer-checked:ring-2 peer-checked:ring-blue-400 rounded-lg p-4 text-center transition-all">
                                    ...
                                    <p class="text-green-400 font-bold mt-2">{{ $cottage->formatted_price_per_day }}</p>
                                </div>
                            </label>
                            @endif

                            @if($cottage->allow_overnight)
                            <label class="cursor-pointer">
                                <input type="radio" name="booking_type" value="overnight" 
                                       x-model="bookingType"
                                       class="sr-only peer" {{ !$cottage->allow_day_use ? 'required' : '' }}>
                                <div class="bg-gray-700 peer-checked:bg-blue-600 peer-checked:ring-2 peer-checked:ring-blue-400 rounded-lg p-4 text-center transition-all">
                                    <svg class="w-8 h-8 mx-auto text-gray-400 peer-checked:text-white mb-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    ...
                                    <p class="text-purple-400 font-bold mt-2">{{ $cottage->formatted_price_per_day }}</p>
                                </div>
                            </label>
                            @endif
                            ...
                            <label class="cursor-pointer">
                                ...
                                <div class="bg-gray-700 peer-checked:bg-blue-600 peer-checked:ring-2 peer-checked:ring-blue-400 rounded-lg p-4 text-center transition-all">
                                    ...
                                    <p class="text-gray-400 text-sm">{{ $cottage->min_hours }}-{{ $cottage->max_hours }} hrs</p>
                                    <p class="text-blue-400 font-bold mt-2">{{ $cottage->formatted_price_per_hour }}/hr</p>
                                </div>
                            </label>
                            @endif

                            @if($cottage->allow_events)
                            <label class="cursor-pointer">
                    ...
                    <div class="bg-gray-800 rounded-lg p-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div x-show="bookingType === 'hourly'">
                                ...
                                <input type="number" 
                                       name="hours" 
                                       min="{{ $cottage->min_hours ?? 1 }}"
                                       max="{{ $cottage->max_hours ?? 12 }}"
                                       value="{{ old('hours', $cottage->min_hours ?? 4) }}"
                                       class="w-full px-4 py-2 bg-gray-700 text-white border border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="number" 
                                       ...
                                       class="w-full px-4 py-2 bg-gray-700 text-white border border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent" 
                                       required>
                                <p class="text-gray-400 text-sm mt-1">Maximum: {{ $cottage->capacity }} persons</p>
                            </div>
                    ...
                    <div class="bg-gray-800 rounded-lg p-6">
                        ...
                        <textarea name="special_requests" 
                                  ...
                                  class="w-full px-4 py-2 bg-gray-700 text-white border border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent">{{ old('special_requests') }}</textarea>
                    </div>
                </div>
                    ...
                    <div class="bg-gray-800 rounded-lg p-6 sticky top-4">
                        ...
                        <div class="space-y-3 mb-4">
                            <div class="flex items-center text-gray-300">
                                ...
                                <span class="font-semibold text-white">{{ $cottage->name }}</span>
                            </div>
                            <div class="flex items-center text-gray-300">
                        ...
                        <div class="border-t border-gray-700 pt-4 mb-4">
                            <div class="flex justify-between text-gray-300 mb-2">
                                ...
                                <span class="font-semibold text-white">{{ $cottage->formatted_price_per_day }}</span>
                            </div>
                            @if($cottage->security_deposit)
                            <div class="flex justify-between text-gray-300">
                                <span>Security Deposit:</span>
                                <span class="text-yellow-400">₱{{ number_format($cottage->security_deposit, 2) }}</span>
                            </div>
                            @endif
                        </div>
