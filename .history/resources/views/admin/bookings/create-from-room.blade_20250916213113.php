...
<div class="container mx-auto px-4 lg:px-8 py-8">
    ...
    <div class="mb-8 flex items-center">
        ...
        <div>
            <h1 class="text-3xl font-bold text-white">Book Room: {{ $room->name }}</h1>
            <p class="text-gray-400 mt-2">Create a booking for this specific room</p>
        </div>
    </div>
    ...
    <div class="bg-gray-800 rounded-lg p-6 mb-8">
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div>
                ...
                <p class="text-green-400 text-2xl font-bold">₱{{ number_format($room->price_per_night, 2) }}</p>
