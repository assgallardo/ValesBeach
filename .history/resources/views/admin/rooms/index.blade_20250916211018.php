...
<div class="container mx-auto px-4 lg:px-16 py-8">
    ...
    <div class="bg-gray-800 rounded-lg p-6 mb-6">
        <form action="{{ route('admin.rooms.index') }}" method="GET" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            <!-- Search -->
            <div>
                        ...
                        <tr class="text-gray-300 hover:bg-gray-700">
                            ...
                            <td class="px-6 py-4">
                                <div class="flex space-x-3">
                                    ...
                                    <a href="{{ route('admin.bookings.createFromRoom', $room) }}" 
