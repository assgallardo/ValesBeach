...
<body class="min-h-screen bg-gray-900 relative overflow-x-hidden" style="font-family: 'Poppins', sans-serif;">
        ...
        <div class="container mx-auto px-4 lg:px-16">
            ...
            <section class="text-center mb-20">
                ...
                <p class="text-xl text-green-100 max-w-3xl mx-auto mb-8">
                    Discover the perfect blend of luxury and nature at Vales Beach Resort. 
                    Your gateway to unforgettable coastal experiences.
                </p>
                <a href="{{ route('guest.rooms') }}" class="inline-block px-8 py-4 bg-green-600 text-white rounded-lg hover:bg-green-700 transition-colors duration-200 text-lg font-medium">
                    Browse Our Rooms
                </a>
            </section>
            ...
            <section class="grid grid-cols-1 md:grid-cols-3 gap-8 mb-20">
                <div class="bg-green-800 rounded-lg p-8 text-center">
                    <h3 class="text-2xl font-semibold text-green-50 mb-4">Luxury Rooms</h3>
                    <p class="text-green-100">Experience comfort in our meticulously designed rooms with modern amenities.</p>
                </div>
                <div class="bg-green-800 rounded-lg p-8 text-center">
                    <h3 class="text-2xl font-semibold text-green-50 mb-4">Beach Access</h3>
                    <p class="text-green-100">Direct access to pristine beaches with breathtaking ocean views.</p>
                </div>
                <div class="bg-green-800 rounded-lg p-8 text-center">
                    <h3 class="text-2xl font-semibold text-green-50 mb-4">Fine Dining</h3>
                    <p class="text-green-100">Savor exquisite cuisine prepared by our world-class chefs.</p>
                </div>
            </section>

            <!-- Call to Action -->
            <section class="text-center">
                <h2 class="text-3xl font-bold text-green-50 mb-6">Ready to Book Your Stay?</h2>
                <div class="flex justify-center space-x-4">
                    <a href="{{ route('signup') }}" class="px-6 py-3 bg-green-600 text-white rounded-lg hover:bg-green-700 transition-colors duration-200">
                        Create an Account
                    </a>
                    <a href="{{ route('guest.rooms') }}" class="px-6 py-3 bg-green-900 text-green-50 rounded-lg hover:bg-green-800 transition-colors duration-200">
                        View Rooms
                    </a>
                </div>
            </section>
    ...
    <!-- Footer -->
    <footer class="relative z-10 bg-green-900 mt-16 py-8">
        <div class="container mx-auto px-4 lg:px-16 text-center">
            <p class="text-green-100">&copy; {{ date('Y') }} Vales Beach Resort. All rights reserved.</p>
        </div>
    </footer>
