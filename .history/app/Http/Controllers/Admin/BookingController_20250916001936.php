        ...
        try {
            ...
            if ($request->has('booking_id') && $request->has('new_status')) {
                ...
                if ($booking) {
                    ...
                    $statusMessage = "Booking #{$booking->id} status updated from " . ucfirst(str_replace('_', ' ', $oldStatus)) . " to " . ucfirst(str_replace('_', ' ', $request->new_status));
                    
                    // Return with success notification
                    return $this->indexWithMessage($request, $statusMessage);
                }
