...
<head>
    ...
    <script>
        ...
        function viewDetails(bookingId) {
            // For now, just scroll to the booking
...
<body>
    ...
    /**
     * Display a specific booking with detailed information.
     */
...
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Booking Details #' . $booking->id . ' - Vales Beach Resort</title>
    <link href="https://fonts.googleapis.com/css2?family=Poppins:wght@300;400;500;600;700&display=swap" rel="stylesheet">
    <style>
        body { 
            font-family: "Poppins", sans-serif; 
        ...
        .status-pending { background-color: rgb(202, 138, 4); }
        .status-confirmed { background-color: rgb(34, 197, 94); }
        .status-cancelled { background-color: rgb(239, 68, 68); }
        .status-checked_in { background-color: rgb(59, 130, 246); }
        .status-checked_out { background-color: rgb(107, 114, 128); }
    </style>
</head>
<body>
    <div class="container">
        <a href="/admin/bookings" class="back-btn">← Back to Bookings</a>
        ...
        <div class="detail-grid">
            <div class="detail-section">
                ...
                <div class="detail-row">
                    ...
                    <span class="detail-value">' . ucfirst(str_replace('_', ' ', $booking->status)) . '</span>
                </div>
                <div class="detail-row">
            ...
            <div class="detail-section">
                ...
                <div class="detail-row">
                    ...
                    <span class="detail-value">' . ucfirst($booking->user->role) . '</span>
                </div>
                <div class="detail-row">
                    <span class="detail-label">Account Status:</span>
                    <span class="detail-value">' . ucfirst($booking->user->status) . '</span>
                </div>
            </div>
            ...
            <div class="detail-section">
                ...
                <div class="detail-row">
                    ...
                    <span class="detail-value">' . ucfirst($booking->room->type) . '</span>
                </div>
                <div class="detail-row">
                    <span class="detail-label">Capacity:</span>
                    <span class="detail-value">' . $booking->room->capacity . ' guests</span>
                </div>
                <div class="detail-row">
                    <span class="detail-label">Price per Night:</span>
                    <span class="detail-value">$' . number_format($booking->room->price_per_night, 2) . '</span>
                </div>
                <div class="detail-row">
                    <span class="detail-label">Room Status:</span>
                    <span class="detail-value">' . ($booking->room->is_available ? 'Available' : 'Not Available') . '</span>
                </div>
            </div>
        </div>
    </div>
            ...
            return response('Booking not found or error occurred: ' . $e->getMessage(), 404);
        }
    }
