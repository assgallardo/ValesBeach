...
<head>
    ...
    <script>
        ...
        function viewDetails(bookingId) {
            ...
            const guestEmail = bookingCard.querySelector(".detail-value").textContent;
                    ...
                    <div class="modal-body">
                        <div style="display: grid; gap: 15px;">
                            <div style="display: flex; justify-content: space-between; padding: 10px; background: rgba(255,255,255,0.05); border-radius: 6px;">
                                ...
                                <span class="status-badge status-" + status.toLowerCase().replace(/ /g, "_") + "\">" + status + "</span>
                            </div>
                            <div style="display: flex; justify-content: space-between; padding: 10px; background: rgba(255,255,255,0.05); border-radius: 6px;">
                            ...
                            <div style="text-align: center; margin-top: 20px;">
                                <button class="btn btn-primary" onclick="window.open('/admin/bookings/${bookingId}', '_blank')">
                                    🔍 View Full Details
                                </button>
