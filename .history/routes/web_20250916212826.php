...
Route::prefix('admin')->name('admin.')->middleware(['auth', 'role:admin,manager,staff'])->group(function () {
    ...
    Route::controller(\App\Http\Controllers\Admin\BookingController::class)->group(function () {
        ...
        Route::get('/bookings/create-from-room/{room}', 'createFromRoom')->name('bookings.createFromRoom');
    ...
    // Reservations - View all reservations (current and past)
    Route::get('/reservations', [\App\Http\Controllers\Admin\BookingController::class, 'reservations'])->name('reservations');
